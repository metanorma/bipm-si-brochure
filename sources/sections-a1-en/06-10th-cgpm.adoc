...
*Definition of the thermodynamic temperature scale* (<<CR1954-3>>)(((kelvin (stem:["unitsml(K)"]))))(((thermodynamic temperature)))(((thermodynamic temperature scale)))
...
[.variant-title,type=quoted]
*Definition of the standard atmosphere* (<<CR1954-4>>) (((standard atmosphere)))
...
[.variant-title,type=quoted]
*Practical system of units* (<<CR1954-6>>)(((kelvin (stem:["unitsml(K)"]))))
