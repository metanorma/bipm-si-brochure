...
*Definition of the thermodynamic temperature scale* (<<CR79>>)(((kelvin (stem:["unitsml(K)"]))))(((thermodynamic temperature)))(((thermodynamic temperature scale)))
...
[.variant-title,type=quoted]
*Definition of the standard atmosphere* (<<CR79>>) (((standard atmosphere)))
...
[.variant-title,type=quoted]
*Practical system of units* (<<CR80>>)(((kelvin (stem:["unitsml(K)"]))))
