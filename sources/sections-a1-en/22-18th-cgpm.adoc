...
*Forthcoming adjustment to the representations of the volt and of the ohm* (<<CR1987-6,page=100>> and _Metrologia_, 1988, *25*, 115) (((ohm (stem:["unitsml(Ohm)"])))) index-range:volt_v[(((volt (stem:["unitsml(V)"]))))]
