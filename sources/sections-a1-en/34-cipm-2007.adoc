...
* an updated list of frequency values for the ^12^C~2~H~2~ stem:[("v"_1 + "v"_3)] band at stem:[1.54 "unitsml(um)"];
* the addition of frequency values for the ^12^C~2~HD stem:[(2"v"_1)] band at stem:[1.54 "unitsml(um)"];
