...
*Revision of the practical realization of the definition of the metre* (<<PV70,page=194-204>> and _Metrologia_, *40*, 103-133) (((metre (stem:["unitsml(m)"]))))
...
* that the list of recommended radiations given by the CIPM in 1997 (Recommendation 1 (CI-1997)) be replaced by the list of radiations given below footnote:[The list of recommended radiations, Recommendation 1 (CI-2002), is given in <<PV70,page=197-204>> and _Metrologia_, 2003, *40*, 104-115.], including
...
[.variant-title,type=quoted]
*Dose equivalent* (<<PV70, page=205>>)index-range:sievert_sv[(((sievert (stem:["unitsml(Sv)"]))))]
