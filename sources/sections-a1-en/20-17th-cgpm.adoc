...
*Definition of the metre* (<<CR1983-1,page=97>> and _Metrologia_, 1984, *20*, 25)(((metre (stem:["unitsml(m)"]))))
...
[.variant-title,type=quoted]
*On the realization of the definition of the metre* (<<CR1983-2,page=98>> and _Metrologia_, 1984, *20*, 25-26)(((metre (stem:["unitsml(m)"]))))
