...
* the unperturbed optical transition ^2^S~1/2~ stem:[(ii(F) = 0) – text()^2 ii(F)_(7//2)" "(ii(F) = 3," "m_"F" = 0)] of the ^171^Yb^+^ ion with a frequency of stem:[f = 642121496772657 " "rm(Hz)] and a relative standard uncertainty of stem:[6 xx 10^(−14)]; 
