...
*Representation of the volt by means of the Josephson effect* (<<PV56,page=44>> and _Metrologia_, 1989, *26*, 69)(((Josephson effect)))(((volt (stem:["unitsml(V)"]))))
...
[.variant-title,type=quoted]
*Representation of the ohm by means of the quantum Hall effect* (<<PV56,page=45>> and _Metrologia_, 1989, *26*,70)index-range:hall_effect[(((Hall effect (incl. quantum Hall effect))))]index-range:ohm_omega[(((ohm (stem:["unitsml(Ohm)"]))))](((quantum Hall effect)))(((von Klitzing constant (stem:[R_K,R_{k-90}]))))
