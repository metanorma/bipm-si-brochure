...
*considering* that the symbol stem:[sf "l"] for the unit litre was adopted by the Comité International des Poids et Mesures (CIPM) in 1879 and confirmed in the same Resolution of 1948,

*considering* also that, in order to avoid the risk of confusion between the letter l and the number 1, several countries have adopted the symbol stem:[sf "L"] instead of stem:[sf "l"] for the unit litre,
...
*decides*, as an exception, to adopt the two symbols stem:[sf "l"] and stem:[sf "L"] as symbols to be used for the unit litre, footnote:[The CIPM, in 1990, considered that it was still too early to choose a single symbol for the litre.]
