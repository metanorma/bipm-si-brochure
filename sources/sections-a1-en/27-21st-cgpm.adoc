...
*The definition of the kilogram* (<<CR331>> and _Metrologia_, 2000, *37*, 94)
...
[.variant-title,type=quoted]
*Special name for the SI derived unit mole per second, the katal, for the expression of catalytic activity* (<<CR334>>-<<CR335>> and _Metrologia_, 2000, *37*, 95) (((katal (stem:["unitsml(kat)"])))) (((mole (stem:["unitsml(mol)"])))) (((non-SI units))) (((second (stem:["unitsml(s)"]))))
