...
[[cgpm15th1975r8_9]]
=== SI units for ionizing radiation (becquerel and gray) (CR, 105 and _Metrologia_, 1975, 11, 180) (((becquerel (Bq)))) index-range:gray[(((gray (Gy))))]
index-range:ionizing_radiation[(((ionizing radiation)))]
