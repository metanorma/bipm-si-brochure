...
*Recommended value for the speed of light* (<<CR103>> and _Metrologia_, 1975, *11*, 179-180)
...
[.variant-title,type=quoted]
*Coordinated Universal Time (UTC)* (<<CR104>> and _Metrologia_, 1975, *11*, 180) index:see[UTC,Coordinated Universal Time] (((Coordinated Universal Time (UTC))))
...
[.variant-title,type=quoted]
*SI units for ionizing radiation (becquerel and gray)* (<<CR105>> and _Metrologia_, 1975, *11*, 180)(((becquerel (stem:["unitsml(Bq)"]))))index-range:gray[(((gray (stem:["unitsml(Gy)"]))))]index-range:ionizing_radiation[(((ionizing radiation)))]
...
[.variant-title,type=quoted]
*SI prefixes peta and exa* (<<CR106>> and _Metrologia_, 1975, *11*, 180-181)((("multiples, prefixes for")))(((prefixes)))(((SI prefixes)))
