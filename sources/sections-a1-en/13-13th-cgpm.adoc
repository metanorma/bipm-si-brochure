...
| specific heat capacity | joule per kilogram kelvin | stem:["unitsml(J//kg*K)")] (((heat capacity)))(((joule (stem:["unitsml(J)"]))))
| thermal conductivity | watt per metre kelvin | stem:["unitsml(W//m*K)")]
