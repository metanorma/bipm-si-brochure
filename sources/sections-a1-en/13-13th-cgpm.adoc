...
*SI unit of time (second)* (<<CR103>> and _Metrologia_, 1968, *4*, 43) (((second (stem:["unitsml(s)"]))))
...
[.variant-title,type=quoted]
*SI unit of thermodynamic temperature (kelvin)* (<<CR104>> and _Metrologia_, 1968, *4*, 43)(((International Temperature Scale of 1990 (ITS-90))))(((kelvin (stem:["unitsml(K)"]))))(((thermodynamic temperature)))
...
[.variant-title,type=quoted]
*Definition of the SI unit of thermodynamic temperature (kelvin)* (<<CR104>> and _Metrologia_, 1968, *4*, 43)(((kelvin (stem:["unitsml(K)"]))))(((thermodynamic temperature)))
...
[.variant-title,type=quoted]
*SI unit of luminous intensity (candela)* (<<CR104>> and _Metrologia_, 1968, *4*, 43-44)(((Luminous intensity)))
...
[.variant-title,type=quoted]
*SI derived units* (<<CR105>> and _Metrologia_, 1968, *4*, 44)index:see["unit, derived",derived unit(s)](((derived unit(s))))((("multiples, prefixes for")))(((prefixes)))
...
[.variant-title,type=quoted]
*Abrogation of earlier decisions (micron and new candle)* (<<CR105>> and _Metrologia_, 1968, *4*, 44) ((("submultiples, prefixes for")))(((candela (stem:["unitsml(cd)"]),new candle)))
