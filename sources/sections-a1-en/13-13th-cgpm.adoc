...
(((International Temperature Scale of 1990 (ITS-90)))) (((kelvin (K))))
...
[[cgpm13th1967r4]]
=== Definition of the SI unit of thermodynamic temperature (kelvin) (CR, 104 and _Metrologia_, 1968, 4, 43) (((kelvin (K))))
...
*decides* to express the definition of the candela(((candela (cd)))) as follows:

"The candela(((candela (cd)))) is the ((luminous intensity)), in the perpendicular direction, of a surface of stem:[1//600000 text( square metre)] of a black body at the temperature of freezing platinum under a pressure of stem:[101325 text( newtons per square metre)]."
____
...
| radiant intensity | watt per steradian | stem:[rm(W)//rm(sr)]
