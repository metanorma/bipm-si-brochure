...
*Pascal and siemens* (<<CR78>>) (((newton (stem:["unitsml(N)"]))))(((ohm (stem:["unitsml(Ohm)"]))))(((pascal (stem:["unitsml(Pa)"]))))(((siemens (stem:["unitsml(S)"]))))
...
[.variant-title,type=quoted]
*International Atomic Time, function of CIPM* (<<CR77>>-<<CR78>> and _Metrologia_, 1972, *8*, 35) (((International Atomic Time (TAI))))
...
[.variant-title,type=quoted]
*SI unit of amount of substance (mole)* (<<CR78>> and _Metrologia_, 1972, *8*, 36)(((mole (stem:["unitsml(mol)"]))))
