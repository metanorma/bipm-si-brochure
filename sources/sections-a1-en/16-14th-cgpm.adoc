...
*Pascal and siemens* (<<CR1971-2>>) (((newton (stem:["unitsml(N)"]))))(((ohm (stem:["unitsml(Ohm)"]))))(((pascal (stem:["unitsml(Pa)"]))))(((siemens (stem:["unitsml(S)"]))))
...
[.variant-title,type=quoted]
*SI unit of amount of substance (mole)* (<<CR1971-2>> and _Metrologia_, 1972, *8*, 36)(((mole (stem:["unitsml(mol)"]))))
