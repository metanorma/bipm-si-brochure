...
*Atomic standard of frequency* (<<CR1964-5,page=93>>)
...
[.variant-title,type=quoted]
*Curie* (<<CR1964-7,page=94>>)(((curie (stem:["unitsml(Ci)"]))))
...
[.variant-title,type=quoted]
*SI prefixes femto and atto* (<<CR1964-8,page=94>>)(((prefixes)))(((SI prefixes)))((("submultiples, prefixes for")))
