...
NOTE: The name "becquerel" (stem:["Bq"]) was adopted by the 15^th^ CGPM in 1975 (<<cgpm15th1975r8_9,Resolution 8>>) for the SI unit of activity: stem:[1 " Ci" = 3.7 times 10^(10) " Bq"].
...
NOTE: New prefixes were added by the 15^th^ CGPM in 1975 (<<cgpm15th1975r10,Resolution 10>>).
