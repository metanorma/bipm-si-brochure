...
NOTE: The name "becquerel"(((becquerel (Bq)))) (stem:["unitsml(Bq)"]) was adopted by the 15th CGPM in 1975 (<<cgpm15th1975r8_9r8_9,Resolution 8>>) for the SI unit of activity: stem:[1 " ""unitsml(Ci)" = 3.7 xx 10^(10) " ""unitsml(Bq)"].
