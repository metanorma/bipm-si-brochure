...
* that, of the seven base units(((base unit(s)))) of the SI, only the kilogram is still defined in terms of a material artefact - the international prototype of the kilogram (2nd CGPM, 1889, 3rd CGPM, 1901) and that the definitions of the ampere(((ampere (A)))), mole and candela depend on the kilogram,
...
* that as a result of recent advances, there are significant implications for, and potential benefits from, redefinitions of the kilogram, the ampere(((ampere (A)))), the kelvin and the mole,
