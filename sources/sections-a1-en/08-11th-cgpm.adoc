...
| dynamic viscosity (((dynamic viscosity (poise)))) | newton-second per square metre | stem:["unitsml(N*s//m^2)"] |
| work, energy, quantity of heat footnote:[Modern practice is to use the phrase "amount of heat" rather than "quantity of heat", because the word quantity has a different meaning in metrology.] | joule | stem:["unitsml(J)"] | stem:["unitsml(N*m)"] (((joule (stem:["unitsml(J)"]))))
| power | watt | stem:["unitsml(W)"] | stem:["unitsml(J//s)"] (((watt (stem:["unitsml(W)"]))))
| quantity of electricity footnote:[Modern practice is to use the phrase "amount of electricity" rather than "quantity of electricity".] | coulomb(((coulomb (stem:["unitsml(C)"])))) | stem:["unitsml(C)"] | stem:["unitsml(A*s)"]
a| tension (voltage), +
...
| capacitance | farad | stem:["unitsml(F)"] | stem:["unitsml(A*s//V)"] (((farad (stem:["unitsml(F)"]))))
| magnetic flux | weber | stem:["unitsml(Wb)"] | stem:["unitsml(V*s)"] (((weber (stem:["unitsml(Wb)"]))))
| inductance | henry | stem:["unitsml(H)"] | stem:["unitsml(V*s//A)"] (((henry (stem:["unitsml(H)"]))))
