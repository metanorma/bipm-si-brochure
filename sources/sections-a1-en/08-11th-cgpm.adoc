...
* Resolution 6 of the 10th CGPM, by which it adopted six base units(((base unit(s)))) on which to establish a practical system of measurement for international use:
+
--
[%unnumbered]
|===
