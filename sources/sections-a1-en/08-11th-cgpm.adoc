...
*Definition of the metre* (<<CR1960-6,page=85>>)(((metre (stem:["unitsml(m)"]))))
...
[.variant-title,type=quoted]
*Definition of the unit of time (second)* (<<CR1960-9,page=86>>)(((second (stem:["unitsml(s)"]))))
...
[.variant-title,type=quoted]
*Système International d'Unités* (<<CR1960-12,page=87>>)(((prefixes)))
...
[.variant-title,type=quoted]
*Cubic decimetre and litre* (<<CR1960-13,page=88>>) (((litre (stem:["unitsml(L)"] or stem:["unitsml(l)"]))))
