...
*Definition of the metre* (<<CR85>>)(((metre (stem:["unitsml(m)"]))))
...
[.variant-title,type=quoted]
*Definition of the unit of time (second)* (<<CR86>>)(((second (stem:["unitsml(s)"]))))
...
[.variant-title,type=quoted]
*Système International d'Unités* (<<CR87>>)(((prefixes)))
...
[.variant-title,type=quoted]
*Cubic decimetre and litre* (<<CR88>>) (((litre (stem:["unitsml(L)"] or stem:["unitsml(l)"]))))
