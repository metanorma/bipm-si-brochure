...
** the luminous efficacy stem:[K_("cd")] of monochromatic radiation of frequency stem:[540 xx 10^(12) " "rm(Hz)] is exactly stem:[683 text( lumen per watt)],
...
* that the thermodynamic temperature of the triple point of water stem:[T_("TPW")] will be stem:[273.16 " "rm(K)] but with a relative uncertainty equal to that of the recommended value of stem:[k] just before redefinition and that subsequently its value will be determined experimentally,
* that the molar mass of carbon 12 stem:[ii(M)(""^{12}"C")] will be stem:[0.012 " "rm(kg)" "rm(mol)^(−1)] but with a relative uncertainty equal to that of the recommended value of stem:[N_"A"h] just before redefinition and that subsequently its value will be determined experimentally.
