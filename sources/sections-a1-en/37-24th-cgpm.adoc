...
* that the molar mass of carbon stem:[12 " " M(""^{12}"C")] will be stem:[0.012 " kg mol"^(−1)] but with a relative uncertainty equal to that of the recommended value of stem:[N_"A"h] just before redefinition and that subsequently its value will be determined experimentally.
