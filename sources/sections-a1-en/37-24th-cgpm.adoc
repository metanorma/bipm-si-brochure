...
** the Planck constant stem:[h] is exactly stem:[6.626 " "06"X" times 10^(−34) text( joule second)],
+
--
NOTE: The stem:["X"] digit appearing in the expression of the constants indicates that this digit was unknown at the time of the resolution.
--
