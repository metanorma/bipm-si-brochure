...
* the mass of the ((international prototype of the kilogram)) stem:[m(cc "K")] will be stem:[1 " "rm(kg)] but with a relative uncertainty equal to that of the recommended value of stem:[h] just before redefinition and that subsequently its value will be determined experimentally,
