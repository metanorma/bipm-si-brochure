...
* that the molar mass of carbon 12 stem:[M(""^{12}"C")] will be stem:[0.012 " "rm(kg)" "rm(mol)^(−1)] but with a relative uncertainty equal to that of the recommended value of stem:[N_"A"h] just before redefinition and that subsequently its value will be determined experimentally.
