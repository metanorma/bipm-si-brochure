...
*On the possible future revision of the International System of Units, the SI* (<<CR2011-1>>)
...
[.variant-title,type=quoted]
*On the revision of the mise en pratique of the metre and the development of new optical frequency standards* (<<CR2011-8>>)
