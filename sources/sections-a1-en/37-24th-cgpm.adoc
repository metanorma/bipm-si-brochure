...
* that of the seven base units(((base unit(s)))) of the SI, only the kilogram is still defined in terms of a material artefact, namely, the international prototype of the kilogram (1st meeting of the CGPM, 1889, 3rd meeting of the CGPM, 1901), and that the definitions of the ampere(((ampere (A)))), mole and candela depend on the kilogram,
