...
((("quantity, base"))) index-range:radian_rad-2[(((radian (rad))))] index-range:steradian_sr-2[(((steradian (sr))))] (((supplementary units)))
...
* that the units radian and steradian(((steradian (sr)))) are usually introduced into expressions for units when there is need for clarification, especially in photometry where the steradian plays an important role in distinguishing between units corresponding to different quantities,
