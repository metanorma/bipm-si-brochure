...
*Declaration concerning the definition of the litre* (<<CR1901-1>>)(((litre (stem:["unitsml(L)"] or stem:["unitsml(l)"]))))
...
[.variant-title,type=quoted]
*Declaration on the unit of mass and on the definition of weight; conventional value of stem:[g_{"n"}]* (<<CR1901-2>>) ((("acceleration due to gravity, standard value of " (stem:[g_{"n"}])))) (((mass))) (((mass and weight)))
