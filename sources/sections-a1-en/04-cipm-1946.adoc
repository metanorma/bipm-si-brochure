...
[[cipm1946r2]]
=== Definitions of electric units (PV, 20, 132-133)(((MKS system)))(((newton (N))))
...
+
--
*_Ampere_* (unit of ((electric current))).:: The ampere(((ampere (A)))) is that constant current which, if maintained in two straight parallel conductors of infinite length, of negligible circular cross-section, and placed 1 metre apart in vacuum, would produce between these conductors a force equal to stem:[2 xx 10^(-7) " " "unitsml(MKS)"] unit of force [newton] per metre of length. footnote:[This definition of the ampere was abrogated in 2018 by the 26th CGPM (<<cgpm26th2018r1r1,Resolution 1>>).] 
