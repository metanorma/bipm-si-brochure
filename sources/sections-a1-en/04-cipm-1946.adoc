...
*_New lumen_* (unit of luminous flux). — The new lumen is the luminous flux emitted in unit solid angle (steradian) by a uniform point source having a luminous intensity of 1 new candle. footnote:[This definition was modified in 1967 by the 13^th^ CGPM (Resolution 5, see p. 169-170).]
--
. . . .
____
