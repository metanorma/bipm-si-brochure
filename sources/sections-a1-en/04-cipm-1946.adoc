...
[NOTE]
====
The two definitions contained in this Resolution were ratified in 1948 by the 9th CGPM, which also approved the name candela(((candela (stem:["unitsml(cd)"])))) given to the "new candle" (<<CR54>>)(((candela (stem:["unitsml(cd)"]),new candle))). For the lumen the qualifier "new" was later abandoned.
====
...
[NOTE]
====
The definitions contained in this Resolution were ratified in 1948 by the 9th CGPM (<<CR49>>), which also adopted the name newton (<<cgpm9th1948r7r7,Resolution 7>>) for the MKS unit of force.
