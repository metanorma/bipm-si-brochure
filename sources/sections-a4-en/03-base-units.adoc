== Historical perspective on the base units(((base unit(s))))

=== Unit of time, second
index-range:second_s[(((second (s))))]
index-range:time_duration[(((time (duration))))]
