...
[NOTE]
====
stem:["m" = 12.3 " "rm(g)] where stem:[rm(m)] is used as a symbol for the quantity mass, but stem:[phi = 30° 22text(') 8text(")], where stem:[ii(phi)] is used as a symbol for the quantity plane angle.
====
