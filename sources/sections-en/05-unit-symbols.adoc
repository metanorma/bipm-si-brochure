...
An exception, adopted by the 16th CGPM (<<CR1979-6,1979, Resolution 6>>), is that either capital L or lower-case l is allowed for the litre, in order to avoid possible confusion between the numeral 1 (one) and the lower-case letter l (el).
