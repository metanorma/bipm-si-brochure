...
An exception, adopted by the 16^th^ CGPM (1979, Resolution 6), is that either capital L or lower-case l is allowed for the litre, in order to avoid possible confusion between the numeral 1 (one) and the lower-case letter l (el).
...
[NOTE]
====
When the SI was adopted by the 11^th^ CGPM in 1960, a category of "supplementary units" was created to accommodate the radian and steradian. Decades later, The CGPM decided:
...
. to eliminate the separate class of supplementary units (Resolution 8 of the 20^th^ CGPM (1995)).
====