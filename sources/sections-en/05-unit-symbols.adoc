...
[NOTE]
====
stem:[m = 12.3 "unitsml(g)"] where stem:["unitsml(m)"] is used as a symbol for the quantity mass, but stem:[ii(varphi) = 30 "unitsml(deg)"] stem:[22 "unitsml(prime)"] stem:[8 "unitsml(dprime)"], where stem:[ii(varphi)] is used as a symbol for the quantity plane angle.
====
...
NOTE: either 3279.1683 or stem:[3279.1683]
