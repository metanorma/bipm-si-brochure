...
[NOTE]
====
For example: The maximum electric potential difference is stem:[U_("max") = 1000 " V"]  but not stem:[U = 1000 " V"_("max")]. The mass fraction of copper in the sample of silicon is stem:[w("Cu") = 1.3 xx 10^(-6)] but not stem:[1.3 xx 10^(-6) " w/w"].
====
...
stem:[(53 " m/s") xx 10.2 " s"] or stem:[(53 " m/s")(10.2 " s")]
