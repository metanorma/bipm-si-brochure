...
| frequency | hertz footnote:d[The hertz shall only be used for periodic phenomena and the becquerel(((becquerel (Bq)))) shall only be used for stochastic processes in ((activity referred to a radionuclide)).] | stem:[rm(Hz) = rm(s)^(−1)] |
...
Lumen and lux are derived from the base unit(((base unit(s)))) candela. Like the candela, they carry information about human vision. The candela was established as a base unit(((base unit(s)))) in 1954, acknowledging the importance of light in daily life. Further information on the units and conventions used for defining photochemical and photobiological quantities is in <<appendix3>>.
