...
[stem%unnumbered]
++++
ii(M)("X") = A_"r"("X")["M"(text()^(12)C)//12] = A_"r"("X") ii(M)_{rm(u)}
++++
...
[stem%unnumbered]
++++
ii(M)("X") = N_"A" m("X") = N_"A" A_"r"("X") m_{rm(u)} .
++++

In these equations stem:[ii(M)_{rm(u)}] is the molar mass constant, equal to stem:[M](^12^C)/12 and stem:[m_{rm(u)}] is the unified atomic mass constant, equal to stem:[m](^12^C)/12. They are related to the Avogadro constant through the relation

[stem%unnumbered]
++++
ii(M)_{rm(u)} = N_"A" m_{rm(u)} .
++++
