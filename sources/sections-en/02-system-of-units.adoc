...
| dose equivalent | sievert(((sievert (stem:["unitsml(Sv)"])))) footnote:[See CIPM Recommendation 2 on the use of the sievert (<<PV70, page=205>>).] | stem:["unitsml(Sv)" = "unitsml(m^2*s^(-2))"] | stem:["unitsml(J/kg)"]
