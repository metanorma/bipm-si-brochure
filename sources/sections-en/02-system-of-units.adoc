...
| dose equivalent | sievert(((sievert (stem:["unitsml(Sv)"])))) footnote:[See CIPM Recommendation 2 on the use of the sievert (PV, 2002, *70*, 205).] | stem:["unitsml(Sv)" = "unitsml(m^2*s^(−2))"] | stem:["unitsml(J/kg)"]
...
NOTE: The International Electrotechnical Commission (IEC) has introduced the var (symbol: stem:["unitsml(var)"]) as a special name for the unit of reactive power. In terms of SI coherent units, the stem:["unitsml(var)"] is identical to the volt ampere(((ampere (stem:["unitsml(A)"])))).
