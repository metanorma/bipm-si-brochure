...
| frequency | hertz footnote:d[The hertz[[hertz_hz]] shall only be used for periodic phenomena and the becquerel shall only be used for stochastic processes in ((activity referred to a radionuclide)).] | stem:[rm(Hz) = rm(s)^(−1)] |
...
| moment of force | newton metre(((metre (m)))) | stem:[rm(N)" "rm(m)] | stem:[rm(kg)" "rm(m)^2 " "rm(s)^(−2)]
