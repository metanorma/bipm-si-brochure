...
Par exemple, en déterminant l’exitance énergétique totale d’un corps noir à la température stem:[ii(T)], équivalente à stem:[(2 pi^5 k^4//15c^2 h^3) T^4], en stem:[rm(W)" "rm(m)^{-2}], il est possible de déterminer directement stem:[ii(T)].
...
L’équation qui en résulte est la suivante stem:[mgv = Ch] où stem:[ii(C)] est une constante d’étalonnage qui
...
[stem%unnumbered]
++++
m = {8V}/{a_0^3} {2ii(R)_{oo}h}/{c alpha^2} m_{"Si"}/m_"e"
++++


avec la masse stem:[m] et le volume stem:[ii(V)] de la sphère (d’environ stem:[1 " "rm(kg)]), le paramètre de réseau stem:[a_0],
la constante de Rydberg stem:[ii(R)_{oo}], la constante de structure fine stem:[alpha], la masse d’un atome de
