...
l’unité de temps, la CGPM à sa 11^e^ réunion (1960, Résolution 9{nbsp}; <<CR1960-9>>) approuva une
...
<<CR1967-1>> et _Metrologia_, 1968, *4*, 43) choisit une nouvelle définition de la seconde fondée sur
...
<<CR1983-1>> et _Metrologia_, 1984, *20*, 25) par une définition fondée sur la ((longueur)) du trajet
...
nouvelles unités absolues. Le CIPM décida en 1946 (1946, Résolution 2, <<PV20_2>>)
...
l’ampère(((ampère (stem:["unitsml(A)"])))) à l’aide de la loi d’Ohm (CGPM, 1987, Résolution 6{nbsp}; <<CR1987-6>>). Par conséquent,
...
10^e^ réunion (1954, Résolution 3{nbsp}; <<CR1954-3>>) qui choisit
...
La CGPM à sa 13^e^ réunion (1967-1968, Résolution 3{nbsp}; <<CR1967-3>> et _Metrologia_, 1968, *4*, 43)
...
en 1967, la CGPM à sa 13^e^ réunion (Résolution 5{nbsp}; <<CR1967-5>> et _Metrologia_, 1968, *4*, 43-44)
...
Résolution 3{nbsp}; <<CR1979-3>> et _Metrologia_, 1980, *16*, 56) adopta une nouvelle définition de la
