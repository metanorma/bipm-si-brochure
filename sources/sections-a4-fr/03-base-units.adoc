...
définitions de l’ampère(((ampère (stem:["unitsml(A)"])))) «&nbsp;international&nbsp;» et de l’ohm «&nbsp;international&nbsp;» furent confirmées par
...
l’ampère(((ampère (stem:["unitsml(A)"])))) à l’aide de la loi d’Ohm (CGPM, 1987, Résolution 6; CR, 100). Par conséquent,
...
adopta le nom «&nbsp;kelvin&nbsp;», symbole stem:["unitsml(K)"], au lieu de «&nbsp;degré kelvin&nbsp;»(((degré kelvin))), symbole stem:["unitsml(degK)"], pour l’unité
...
définition de la mole(((mole (stem:["unitsml(mol)"])))) en 1967 qu’il confirma en 1969: la ((masse)) molaire
...
symbole stem:["unitsml(cd)"]; en 1954, la CGPM à sa 10^e^ réunion établit la candela(((candela (stem:["unitsml(cd)"])))) comme unité de base;
