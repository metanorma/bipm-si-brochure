...
adopta le nom «&nbsp;kelvin&nbsp;», symbole stem:["unitsml(K)"], au lieu de «&nbsp;degré kelvin&nbsp;»(((degré kelvin))), symbole stem:["unitsml(°K)"], pour l’unité
...
symbole stem:["unitsml(cd)"]; en 1954, la CGPM à sa 10^e^ réunion établit la candela(((candela (cd)))) comme unité de base;
