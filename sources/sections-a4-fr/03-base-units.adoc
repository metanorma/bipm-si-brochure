...
et déclara{nbsp}: «&nbsp;Ce prototype sera considéré désormais comme unité de masse&nbsp;».
...
signification du terme «&nbsp;poids&nbsp;», confirma que «&nbsp;le kilogramme est l’unité de masse{nbsp}; il est
égal à la ((masse)) du prototype international du kilogramme&nbsp;»{nbsp}; la version complète de cette
...
(((effet,Hall (y compris Hall quantique))))(((effet,Josephson)))(((volt (V))))
...
l’ampère(((ampère (A)))) à l’aide de la loi d’Ohm (CGPM, 1987, Résolution 6{nbsp}; CR, 100). Par conséquent,
...
=== Unité de température thermodynamique, le kelvin (((kelvin (K)))) (((température,thermodynamique))) ((("eau, composition isotopique")))
...
=== Unité de quantité de matière, la mole index-range:mole_mol-2[(((mole (mol))))](((molécule gramme)))(((poids atomique)))(((poids moléculaire)))(((quantité de matière))) index-range:quantite_matiere-2[(((quantité de matière)))] index-range:carbone[(((carbone)))]
...
définition de la mole(((mole (mol)))) en 1967 qu’il confirma en 1969{nbsp}: la ((masse)) molaire
...
symbole stem:[rm(cd)]{nbsp}; en 1954, la CGPM à sa 10^e^ réunion établit la candela(((candela (cd)))) comme unité de base{nbsp};
