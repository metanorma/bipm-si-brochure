...
stem:[N_"A"], de sorte que stem:[n = N//N_"A"]. L’unité de quantité de matière est appelée la _mole_, symbole stem:[rm(mol)].
...
[stem%unnumbered]
++++
n_"S"("X") = m_"S" // ii(M)("X"), " and " ii(M)(""X"") = A_"r"("X") " g/mol"
++++
...
lumineuse d’un rayonnement monochromatique de fréquence stem:[540 xx 10^(12) " "rm(Hz)], stem:[K_"cd"],
a été adoptée par la CGPM à sa 26^e^ réunion (2018) dans sa Résolution 1.
