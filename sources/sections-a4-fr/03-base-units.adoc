...
l’unité de temps, la CGPM à sa 11^e^ réunion (1960, Résolution 9{nbsp}; <<CR1960-9,page=86>>) approuva une
...
<<CR1967-1,page=103>> et _Metrologia_, 1968, *4*, 43) choisit une nouvelle définition de la seconde fondée sur
...
<<CR1983-1,page=97>> et _Metrologia_, 1984, *20*, 25) par une définition fondée sur la ((longueur)) du trajet
...
(<<CR1889-1,page=34-38>>), est toujours conservé au BIPM dans les conditions fixées en 1889. Afin de
...
CGPM à sa 1^ère^ réunion en 1889 (<<CR1889-1,page=34-38>>) lorsque cette dernière sanctionna le prototype
...
((Convention du Mètre)) et certains au BIPM. La CGPM à sa 3^e^ réunion en 1901 (<<CR1901-2,page=70>>),
...
l’ampère(((ampère (stem:["unitsml(A)"])))) à l’aide de la loi d’Ohm (CGPM, 1987, Résolution 6{nbsp}; <<CR1987-6,page=100>>). Par conséquent,
...
10^e^ réunion (1954, Résolution 3{nbsp}; <<CR1954-3,page=79>>) qui choisit
...
La CGPM à sa 13^e^ réunion (1967-1968, Résolution 3{nbsp}; <<CR1967-3,page=104>> et _Metrologia_, 1968, *4*, 43)
...
en 1967, la CGPM à sa 13^e^ réunion (Résolution 5{nbsp}; <<CR1967-5,page=104>> et _Metrologia_, 1968, *4*, 43-44)
...
Résolution 3{nbsp}; <<CR1979-3,page=100>> et _Metrologia_, 1980, *16*, 56) adopta une nouvelle définition de la
