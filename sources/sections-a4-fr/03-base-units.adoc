...
de l’atome de césium 133 non perturbé, stem:[Delta ii(nu)_{Cs}], a été adoptée par la CGPM à sa 26^e^ réunion
...
perméabilité magnétique du vide stem:[ii(mu)_0] (ou constante magnétique). La valeur de la permittivité
...
symbole stem:[rm(cd)]; en 1954, la CGPM à sa 10^e^ réunion établit la candela comme unité de base;
