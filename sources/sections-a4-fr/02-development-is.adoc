...
La CGPM à sa 9^e^ réunion (1948, Résolution 6{nbsp}; <<CR1948-6>>), chargea le CIPM{nbsp}:
...
Cette même CGPM adopta aussi la Résolution 7 (<<CR1948-7>>) qui fixe des principes généraux
pour l’écriture des symboles d’unités et donne une liste de quelques unités cohérentes ayant
un nom spécial.
(((température,thermodynamique)))
(((temps,durée)))

La CGPM à sa 10^e^ réunion (1954, Résolution 6{nbsp}; <<CR1954-6>>) adopta comme grandeurs et unités
...
14^e^ réunion (1971, Résolution 3, <<CR1971-3>> et _Metrologia_ 1972, *8*, 36) ajouta la quantité de
...
La CGPM à sa 11^e^ réunion (1960, Résolution 12{nbsp}; <<CR1960-12>>) adopta le nom
