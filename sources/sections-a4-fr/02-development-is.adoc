...
les six unités de base correspondantes: mètre, kilogramme, seconde, ampère(((ampère (A)))), kelvin et
...
unité, de nature électrique, telle que l’ampère(((ampère (A)))) ou l’ohm, et en rationalisant les
...
le kilogramme, la seconde et l’ampère(((ampère (A)))) (système MKSA), une proposition qui fut
