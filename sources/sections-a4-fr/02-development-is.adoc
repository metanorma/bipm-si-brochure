...
symbole stem:["mol"], a été adoptée pour la quantité de matière. Cela fit suite à une
...
la constante d’Avogadro stem:[N_"A"] et l’efficacité lumineuse stem:[K_{"cd"}] d’un rayonnement visible
défini.
