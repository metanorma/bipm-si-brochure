...
La CGPM à sa 9^e^ réunion (1948, Résolution 6{nbsp}; CR, 64), chargea le CIPM{nbsp}:
...
La CGPM à sa 10^e^ réunion (1954, Résolution 6{nbsp}; CR, 80) adopta comme grandeurs et unités
...
les six unités de base correspondantes{nbsp}: mètre(((mètre (m)))), kilogramme, ((seconde)), ampère(((ampère (A)))), kelvin et
...
La CGPM à sa 11^e^ réunion (1960, Résolution 12{nbsp}; CR, 87) adopta le nom
