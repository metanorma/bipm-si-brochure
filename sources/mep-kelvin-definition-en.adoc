...
[stem]
++++
ii(epsilon)_"r" = {ii(C)(p)} / {ii(C)(0)(1 + kappa_{"eff"}p)}
++++

where stem:[kappa_{"eff"}] is the negative isothermal effective compressibility and stem:[ii(C)(0)] is the capacitance of the
