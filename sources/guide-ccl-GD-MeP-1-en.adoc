...
wavelengths _e.g._ from neodymium YAG lasers (532.245 03 nm) have been used
...
* recent work, preparing for the forthcoming revision of the SI, has resulted in an agreed CODATA value for the Si {220} lattice spacing, stem:[d_{220} = 192.015" "571" "4 times 10^{-12}] stem:["m"], which is available with a standard uncertainty of stem:[0.000" "003" "2 times 10^{-12}] stem:["m"],
