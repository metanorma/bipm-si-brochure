...
The Si {220} lattice spacing, stem:[d_{220} = 192.015" "571" "4 xx 10^{-12}] stem:["m"], may be used as a secondary realisation of the definition of the metre, for dimensional nanometrology applications, using the following techniques, and with the associated caveats and uncertainty limits:
...
stem:[d_{220} = 192.015" "5714(32)] stem:["pm"] with a standard uncertainty of stem:[0.000" "0032 xx 10^{-12}] stem:["m"],
