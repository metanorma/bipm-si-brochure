...
<| Temperature | stem:[20" "rm(°C)] | stem:[-9.2 xx 10^(-7) " "rm(K)^(-1)]
<| Pressure | stem:[101.325" "rm(Pa)] | stem:[+ 2.7 xx 10^(-9)" "rm(Pa)^(-1)]
<a| stem:["CO"_2] content | stem:[400" "rm(pp)rm(m)] | stem:[+ 1.4 xx 10^(-10)" ("rm(pp)rm(m)")"^(-1)]
<| Humidity: | |
>| Relative humidity | stem:[50" % RH"] | stem:[-8.7 xx 10^(-9)" (% RH)"^(-1)]
>| Dew point | stem:[9.27" "rm(°C)] | stem:[-1.5 xx 10^(-8)" "rm(K)^(-1)]
>| Water vapour pressure | stem:[1168" "rm(Pa)] | stem:[-1.8 xx 10^(-10)" "rm(Pa)^(-1)]
|===
