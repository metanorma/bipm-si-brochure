...
____
*The metre, symbol m, is the SI unit of length. It is defined by taking the fixed numerical value of the speed of light in vacuum stem:[c] to be stem:[299792458] when expressed in the unit stem:["m s"^{-1}], where the second is defined in terms of the caesium frequency stem:[Delta nu_{"Cs"}].*
____
...
<| Temperature | 20 °C | stem:[-9.2 xx 10^(-7) " K"^(-1)]
<| Pressure | stem:[101.325" Pa"] | stem:[+ 2.7 xx 10^(-9)" Pa"^(-1)]
<a| stem:["CO"_2] content | stem:[400" ppm"] | stem:[+ 1.4 xx 10^(-10)" (ppm)"^(-1)]
<| Humidity: | |
>| Relative humidity | 50 % RH | stem:[-8.7 xx 10^(-9)" (% RH)"^(-1)]
>| Dew point | 9.27 °C | stem:[-1.5 xx 10^(-8)" K"^(-1)]
>| Water vapour pressure | 1168 Pa | stem:[-1.8 xx 10^(-10)" Pa"^(-1)]
|===
...
[cols="<,^,^,^,^",options="header"]
|===
| Atom <a| Theoretical Radius (nm) <a| Experimental radius (nm) <a| Theoretical strain parameter stem:[beta] (stem:[10^{-24}] stem:["cm"^{-3}]) <a| Experimental strain parameter stem:[beta] (stem:[10^{-24}] stem:["cm"^(-3)])
...
| Depends on aperture diameter (stem:[d]) and focal length (stem:[f]) of collimator, _e.g._ for stem:[d = 1] stem:["mm"], stem:[f = 1000] stem:["mm"], fractional error (given by stem:[d^2 // 16 f^2]) is stem:[bb (6.25 xx 10^{-8})].
...
| Directly contributes to error with 1:1 correspondence, _e.g._ consider a 1 m mechanical arm made of steel (CTE stem:[10.7 xx 10^{-6}] stem:["K"^{-1}]), a 1 °C change in temperature would change the arm length by stem:[bb 10.7] stem:[bb (mu "m")], leading to a length error of the same value.
...
stem:[d_{220} = 192.0155714(32)] stem:["pm"] with a standard uncertainty of stem:[0.0000032 xx 10^{-12}] stem:["m"],
...
where stem:[a_0 = 543.1020504(89) " pm"] (<<newell>>; specified for natural silicon at 22.5 °C) is the lattice constant and stem:["h"], stem:["k"], and stem:["l"] are the Miller indices.
