...
where stem:[ii(K)_"m"] is maximum luminous efficacy, stem:[ii(Phi)_{"e",ii(lambda)}] is spectral radiant flux, stem:[ii(V)(ii(lambda))] is spectral luminous efficiency and stem:[ii(lambda)] is wavelength.
====
