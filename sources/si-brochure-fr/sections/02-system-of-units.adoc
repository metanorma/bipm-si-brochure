...
stem:[c = 299 792 458] stem:["m/s"] où la valeur numérique
est stem:[299 792 458] et l’unité m/s.
...
césium 133 non perturbé, stem:[Delta ν_{C_s}], est égale à stem:[9 192 631 770] stem:["Hz"],
* la vitesse de la lumière dans le vide, stem:[c], est égale à stem:[299 792 458] stem:["m/s"],
...
| intensité lumineuse | stem:[I_v] | candela | stem:["cd"]
...
9192631770 lorsqu’elle est exprimée en Hz, unité égale à stem:["s"^{-1}].*
...
lorsqu’elle est exprimée en stem:["m s"^{-1}], la seconde étant définie en fonction de stem:[Delta ν_{c_s}].*
...
d’Avogadro, stem:[N_A], lorsqu’elle est exprimée en stem:["mol"^{-1}].*
...
683 lorsqu’elle est exprimée en stem:["lmW"^{-1}], unité égale à stem:["cd srW"^{-1}], ou stem:["cd sr kg"^{-1} "m"^2 "s"^3],
...
augmente de stem:[2 pi] stem:["rad"] à chaque période. Le radian était auparavant une unité SI supplémentaire mais
...
| flux lumineux | lumen | stem:["lm" = "cd sr (g)"] | stem:["cd sr"]
...
angulaire » de façon explicite en Hz ou rad/s mais pas en stem:["s"^{-1}].
