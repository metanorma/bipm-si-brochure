...
[.variant-title,type=quoted]
*Déclaration relative à l’unité de masse et à la définition du poids{nbsp}; valeur conventionnelle de stem:[g_{"n"}]* (<<CR1901-2>>) ((("accélération due à la pesanteur "(stem:[g_{"n"}])))) (((masse))) (((masse et poids)))
...
. Le terme _poids_ désigne une grandeur de la même nature qu’une _force_{nbsp}; le poids d’un corps
