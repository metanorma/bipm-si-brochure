...
nombres furent d’abord proposés par la CGPM à sa 9^e^ réunion (<<CR1948-7>>).
...
constitue une exception à cette règle. La CGPM à sa 16^e^ réunion (<<CR1979-6>>)
...
sa 22^e^ réunion (<<CR2003-10>>), «{nbsp}le symbole du
...
Conformément à la décision de la CGPM à sa 9^e^ réunion (<<CR1948-7>>) et à sa
22^e^ réunion (<<CR2003-10>>), les nombres comportant un grand nombre de
...
[[scls547]]
==== Grandeurs d’unité «{nbsp}un{nbsp}»

Comme mentionné dans la <<dim_des_grandeurs>>, les valeurs des grandeurs d’unité «{nbsp}un{nbsp}» peuvent être simplement exprimées par des nombres. Le symbole d’unité, 1, ou le nom d’unité «{nbsp}un{nbsp}» sont rarement écrits de façon explicite. Comme les symboles de préfixes du SI ne peuvent pas être
...
grandeurs(((grandeurs))) qui sont un nombre d’entités.

Bien que ne faisant pas partie du SI, des termes descriptifs sont couramment utilisés
pour remplacer l’unité «{nbsp}un{nbsp}» afin de qualifier les entités considérées lors de
l’expression de valeurs de grandeurs qui sont un nombre d’entités. Lorsque tel
est le cas, ces termes et leur convention d’utilisation doivent être clairement
définis. En outre, les principes généraux présentés au chapitre 5 de la Brochure
sur le SI doivent être respectés.
...
Le terme «{nbsp}partie par million{nbsp}» ou «{nbsp}ppm{nbsp}»(((ppm))), qui signifie stem:[10^{-6}] en valeur relative ou stem:[1 xx 10^{-6}],
...
d’éviter de les employer. [[regles_ecriture]] [[symboles_recommandes]] [[symboles_ecriture]]
