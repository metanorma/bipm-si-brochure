= Recommended Values of Standard Frequencies: Ytterbium 171 Atom (stem:[f ~~ 518" "rm(THz)])
:appendix-id: 2
:partnumber: 2.12
:edition: 9
:copyright-year: 2019
...
:title-part-en: Ytterbium 171 Atom (stem:[f ~~ 518" "rm(THz)])
:title-part-fr: Ytterbium 171 Atom (stem:[f ~~ 518" "rm(THz)])
...
*^171^Yb neutral atom, stem:[6rm(s)^2" "^1rm(S)_0 - 6rm(s)6rm(p)" "^3rm(P)_0] unperturbed optical transition*

== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies

[align=left]
stem:[f (""^171 rm(Yb)) = 518295836590863.6 " "rm(Hz)]

equivalent to

stem:[ii(lambda) ""^171 rm(Yb) = 578419575.916163 " "rm(fm)],
...
* [[[takano,37]]], T. Takano, R. Mizushima, H. Katori: Precise determination of the isotope shift of stem:[""^{88}rm(Sr) - ""^{87}rm(Sr)] optical lattice clock by sharing perturbations; _Appl. Phys. Express_ *10*, 072801 (2017)
