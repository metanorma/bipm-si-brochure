= Recommended Values of Standard Frequencies: Hydrogen stem:[text()^1 H] Atom (stem:[f ~~ 1233" "rm(THz)])
:appendix-id: 2
:partnumber: 1
:edition: 9
:copyright-year: 2019
...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Hydrogen stem:[text()^1 H] Atom (stem:[f ~~ 1233" "rm(THz)])
:title-appendix-fr:
