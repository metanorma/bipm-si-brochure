...
:language: en
:docnumber:
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Rubidium 87 Atom (stem:[f ~~ 6.835" GHz"])
:title-appendix-fr:
...
[align=left]
_f_(^87^Rb) stem:[= 6834682.6109043126 " Hz"] +
