...
_f_(^40^Ca^+^) = 411 042 129 776 399.8 Hz

equivalent to

stem:[lambda](^40^Ca^+^) = 729 347 276.793 944 fm,

with a relative standard uncertainty of stem:[2.4 xx 10^(−15)].

=== Source data

The adopted value of _f_(^40^Ca^+^) = 411 042 129 776 399.8 Hz with a relative standard uncertainty of stem:[2.4 xx 10^(−15)]
