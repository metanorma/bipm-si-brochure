...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Calcium 40 Ion (stem:[f ~~ 411" THz"])
:title-appendix-fr:
...
_f_(^40^Ca^+^) stem:[= 411042129776399.8 " Hz"]

equivalent to

stem:[lambda](^40^Ca^+^) = stem:[729347276.793944 " fm"],

with a relative standard uncertainty of stem:[2.4 xx 10^(−15)].

=== Source data

The adopted value of _f_(^40^Ca^+^) = stem:[411042129776399.8 " Hz"] with a relative standard uncertainty of stem:[2.4 xx 10^(−15)]
