...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Krypton spectral lamp (stem:[ii(lambda) ~~ 606" "rm(nm)]) (2003)
:title-appendix-fr:
