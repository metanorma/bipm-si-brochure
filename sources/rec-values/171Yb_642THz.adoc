...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Ytterbium 171 Ion (stem:[f ~~ 642" "rm(THz)])
:title-appendix-fr:
...
stem:[f](^171^Yb^+^, octupole) stem:[= 642121496772645.0 " "rm(Hz)]

equivalent to

stem:[ii(lambda)](^171^Yb^+^) stem:[= 466878090.060497 " "rm(fm)]
...
[align=left]
Adopted value:: stem:[f](^171^Yb^+^, octupole) stem:[= 642121496772645.0" "rm(Hz)] +
