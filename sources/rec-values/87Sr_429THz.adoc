...
_f_(^87^Sr) = 429 228 004 229 873.0 Hz

equivalent to

stem:[lambda](^87^Sr) = 698 445 709.612 754 4 fm,
...
The adopted value of _f_(^87^Sr) = 429 228 004 229 873.0 Hz with a relative standard uncertainty of stem:[4 xx 10^(−16)]
