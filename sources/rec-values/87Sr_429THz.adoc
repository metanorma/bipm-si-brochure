...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Strontium 87 Atom (stem:[f ~~ 429" "rm(THz)])
:title-appendix-fr:
...
stem:[f](^87^Sr) stem:[= 429228004229873.0 " "rm(Hz)]

equivalent to

stem:[ii(lambda)](^87^Sr) stem:[= 698445709.6127544 " "rm(fm)],
...
The adopted value of _f_(^87^Sr) stem:[= 429228004229873.0 " "rm(Hz)] with a relative standard uncertainty of stem:[4 xx 10^(−16)]
