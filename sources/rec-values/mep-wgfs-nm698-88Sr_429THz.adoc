...
stem:[f text()^88 Sr = 429228066418007.0 " "rm(Hz)]

equivalent to

stem:[ii(lambda) text()^88 Sr = 698445608.419382 " "rm(fm)],

with a relative standard uncertainty of stem:[6 xx 10^(−16)].

== Source data

The adopted value of stem:[f text()^88 Sr = 429228066418007.0 " "rm(Hz)] with a relative standard uncertainty of stem:[6 xx 10^(−16)]
