= Recommended Values of Standard Frequencies: Strontium 88 Atom (stem:[f ~~ 429"unitsml(THz)"])
:appendix-id: 2
:partnumber: 2.21
:edition: 9
:copyright-year: 2019
:language: en
:docnumber: SI MEP M REC 429THz 88Sr
:title-appendix-en: Recommended values of standard frequencies for applications including the practical realization of the metre and secondary representations of the second
:title-appendix-fr: Valeurs recommandées des fréquences étalons destinées à la mise en pratique de la définition du mètre et aux représentations secondaires de la seconde
:title-part-en: Strontium 88 Atom (stem:[f ~~ 429"unitsml(THz)"])
:title-part-fr: Strontium 88 Atom (stem:[f ~~ 429"unitsml(THz)"])
...
== Strontium 88 Atom (stem:[f ~~ 429"unitsml(THz)"])

*^88^Sr neutral atom, stem:[5"s"^2 " "^1"S"_0 - 5"s"5"p" " "^3"P"_0] unperturbed optical transition*

== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies

stem:[f (""^88 "unitsml(Sr)") = 429228066418007.0 "unitsml(Hz)"]

equivalent to

stem:[ii(lambda) ""^88 "unitsml(Sr)" = 698445608.419382 "unitsml(fm)"],

with a relative standard uncertainty of stem:[6 xx 10^(−16)].

== Source data

The adopted value of stem:[f (""^88 "unitsml(Sr)") = 429228066418007.0 "unitsml(Hz)"] with a relative standard uncertainty of stem:[6 xx 10^(−16)]

has been calculated by the methods presented in <<margolis>>, <<robertsson>>, <<oates>>, <<riehle>>, with the data from the table of frequencies (2017) attached below. A value of the isotope shift between ^88^Sr and ^87^Sr <<akatsuka>> that has been used in the previous recommendation has been withdrawn. Given that the calculated uncertainty is dominated by the uncertainty of the frequency ratio of ref. <<nemitz>>, the CCTF enlarged the recommended uncertainty to stem:[6 xx 10^(−16)], which is the fractional uncertainty of the best realisation of the 88Sr standard today (ref. <<nemitz>>).
...
* [[[margolis,2]]], H. S. Margolis, P. Gill: Least-squares analysis of clock frequency comparison data to deduce optimized frequency and frequency ratio values; _Metrologia_ *52*, 628 (2015)

* [[[robertsson,3]]], L. Robertsson: On the evaluation of ultra-high-precision frequency ratio measurements: examining closed loops in a graph theory framework; _Metrologia_ *53*, 1272 (2016)

* [[[oates,4]]], Chris Oates: private communication. An independent program was developed in Mathematica at NIST (2017)

* [[[riehle,5]]], F. Riehle, P. Gill, F. Arias, L. Robertsson: The CIPM List of Recommended Frequency Standard Values: Guidelines and Procedures; _Metrologia_ *55*, 188-200 (2018)

* [[[akatsuka,6]]], T. Akatsuka, M. Takamoto, H. Katori: Optical lattice clocks with non-interacting bosons and fermions; _Nature Physics_ *4*, 954 – 959 (2008)
