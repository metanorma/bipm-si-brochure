...
:title-part-en: Strontium 88 Atom (stem:[f ~~ 429" "rm(THz)])
:title-part-fr: Strontium 88 Atom (stem:[f ~~ 429" "rm(THz)])
...
*^88^Sr neutral atom, stem:[5rm(s)^2 " "^1rm(S)_0 - 5rm(s)5rm(p) " "^3rm(P)_0] unperturbed optical transition*

== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies

stem:[f (""^88 rm(Sr)) = 429228066418007.0 " "rm(Hz)]

equivalent to

stem:[ii(lambda) ""^88 rm(Sr) = 698445608.419382 " "rm(fm)],

with a relative standard uncertainty of stem:[6 xx 10^(−16)].

== Source data

The adopted value of stem:[f (""^88 rm(Sr)) = 429228066418007.0 " "rm(Hz)] with a relative standard uncertainty of stem:[6 xx 10^(−16)]
