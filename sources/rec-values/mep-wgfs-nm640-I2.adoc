= Recommended Values of Standard Frequencies: Iodine (stem:[ii(lambda) ~~ 640" "rm(nm)])
:appendix-id: 2
:partnumber: 2.17
:edition: 9
:copyright-year: 2003
...
*Absorbing molecule ^127^I~2~, stem:[rm(a)_9] component, P(10) 8-5 transition* footnote:[All transitions in I~2~ refer to the stem:["B"^3Pi" "0_u^+ - "X"^1" "Sigma_g^+] system.]
...
h| stem:[rm(a)_n] h| stem:[[f (rm(a)_n) - f (rm(a)_9)\]//rm(MHz)] h| stem:[u_c//rm(MHz)] h| stem:[rm(a)_n] h| stem:[[f (rm(a)_n) - f (rm(a)_9)\]//rm(MHz)] h| stem:[u_c//rm(MHz)]

| stem:[rm(a)_1] |stem:[-495.4] | stem:[0.4] | stem:[rm(a)_9] | stem:[0] | --
| stem:[rm(a)_2] |stem:[-241.5] | stem:[0.7] | stem:[rm(a)_{10}] | stem:[77.84] | 0.03
| stem:[rm(a)_3] |stem:[-233.0] | stem:[0.4] | stem:[rm(a)_{11}] | stem:[186.22] | 0.07
| stem:[rm(a)_4] |stem:[-177.8] | stem:[1.3] | stem:[rm(a)_{12}] | stem:[199.51] | 0.07
| stem:[rm(a)_5] |stem:[-175.2] | stem:[0.6] | stem:[rm(a)_{13}] | stem:[256.6] | 0.2
| stem:[rm(a)_6] |stem:[-130.8] | stem:[0.1] | stem:[rm(a)_{14}] | stem:[272.75] | 0.07
| stem:[rm(a)_7] |stem:[-82.45] | stem:[0.03] | stem:[rm(a)_{15}] | stem:[374.0] | 0.2
| stem:[rm(a)_8] |stem:[-61.85] | stem:[0.14] | | |
6+a| Frequency referenced to::
stem:[rm(a)_9], P(10) 8-5, ^127^I~2~: stem:[f = 468218332.4" "rm(MHz)] <<ci2002>>
|===
...
h| stem:[rm(b)_n] h| stem:[[f (rm(b)_n) - f (rm(a)_9)\]//rm(MHz)] h| stem:[u_c//rm(MHz)]

| stem:[rm(b)_1] | stem:[62.834] | 0.01
| stem:[rm(b)_2] | stem:[329.8] | 0.2
| stem:[rm(b)_3] | stem:[335.99] | 0.02
3+a| Frequency referenced to:: stem:[rm(a)_9], P(10) 8-5, ^127^I~2~: stem:[f = 468218332.4" "rm(MHz)] <<ci2002>>
|===
Ref. <<glaser1987>>, <<bertinetto>>, <<bennett1978>>, <<kegung>>, <<zhao1983>>, <<zhao1985>>, <<glaser1985>>, <<zhao1987>>
...
* [[[zhao1987,15]]], Zhao K.-G., Li C.-Y., Li H., Xu J., Way H., Investigations of ^127^I~2~-Stabilized stem:[rm(He) - rm(Ne)] Laser at 640 nm, _Acta Metrologica Sinica_, 1987, *8*, 88-95.
