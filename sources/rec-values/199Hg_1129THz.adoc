...
== Mercury 199 Atom (stem:[f ~~ 1" "129" THz"])
...
[align=left]
_f_(^199^Hg) = 1 128 575 290 808 154.4 Hz

equivalent to

stem:[lambda](^199^Hg) = 265 637 977.759 838 7 fm,
...
3+h| ^171^Yb /^87^Sr
| 1.207 507 039 343 341 2 | stem:[1.4 xx 10^(−15)] | <<akamatsu-freq-ratio>>, <<akamatsu-errata>>
