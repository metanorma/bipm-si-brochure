= Recommended Values of Standard Frequencies: Rubidium 87 Atom (stem:[f ~~ 6.835" "rm(GHz)])
:appendix-id: 2
:partnumber: 2.29
:edition: 9
:copyright-year: 2019
...
:title-part-en: Rubidium 87 Atom (stem:[f ~~ 6.835" "rm(GHz)])
:title-part-fr: Rubidium 87 Atom (stem:[f ~~ 6.835" "rm(GHz)])
...
[align=left]
stem:[f text()^87 Rb = 6834682.6109043126 " "rm(Hz)] +
...
| stem:[429228004229873.5]6] | stem:[0.49] | <<tanabe>>
