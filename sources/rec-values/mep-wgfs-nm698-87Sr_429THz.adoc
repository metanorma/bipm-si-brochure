= Recommended Values of Standard Frequencies: Strontium 87 Atom (stem:[f ~~ 429"unitsml(THz)"])
:appendix-id: 2
:partnumber: 2.20
:edition: 9
:copyright-year: 2019
...
:title-part-en: Strontium 87 Atom (stem:[f ~~ 429"unitsml(THz)"])
:title-part-fr: Strontium 87 Atom (stem:[f ~~ 429"unitsml(THz)"])
...
== Strontium 87 Atom (stem:[f ~~ 429"unitsml(THz)"])

*^87^Sr neutral atom, stem:[5"s"^2 " "^1"S"_0 - 5"s"5"p" " "^3"P"_0] unperturbed optical transition*

== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies

stem:[f (""^87 "unitsml(Sr)") = 429228004229873.0 "unitsml(Hz)"]

equivalent to

stem:[ii(lambda) ""^87 "unitsml(Sr)" = 698445709.6127544 "unitsml(fm)"],
...
The adopted value of stem:[f(""^{87}"unitsml(Sr)") = 429228004229873.0 "unitsml(Hz)"] with a relative standard uncertainty of stem:[4 xx 10^(−16)]
