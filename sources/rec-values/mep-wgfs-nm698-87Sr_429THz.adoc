...
stem:[f ("^87 Sr") = 429228004229873.0 "unitsml(Hz)"]

equivalent to

stem:[ii(lambda) "^87 Sr" = 698445709.6127544 "unitsml(fm)"],
...
The adopted value of stem:[f(""^{87}"Sr") = 429228004229873.0 "unitsml(Hz)"] with a relative standard uncertainty of stem:[4 xx 10^(−16)]
