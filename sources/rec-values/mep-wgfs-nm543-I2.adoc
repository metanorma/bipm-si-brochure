...
.stem:[ii(lambda) ~~ 543" "rm(nm)] ^127^I~2~ R(12) 26-0
|===
| stem:[a_n] | stem:[[f (a_n) – f (b_(10))\]//rm(MHz)] | stem:[u_c//rm(MHz)] | stem:[a_n] | stem:[[f (a_n) – f (b_(10))\]//rm(MHz)] | stem:[u_c//rm(MHz)]

| stem:[a_1] | –1162.24 | stem:[0.02] | stem:[a_9] | –679.420 | 0.005
| stem:[a_2] | –909.87 | stem:[0.02] | stem:[a_(10)] | –596.134 | 0.005
| stem:[a_3] | –900.11 | stem:[0.03] | stem:[a_(11)] | –485.61 | 0.01
| stem:[a_4] | –853.336 | stem:[0.005] | stem:[a_(12)] | –476.35 | 0.01
| stem:[a_5] | –848.131 | stem:[0.005] | stem:[a_(13)] | –423.23 | 0.01
| stem:[a_6] | –795.92 | stem:[0.01] | stem:[a_(14)] | –410.01 | 0.01
| stem:[a_7] | –752.382 | stem:[0.005] | stem:[a_(15)] | –305.910 | 0.005
| stem:[a_8] | –733.134 | stem:[0.005] | | |
...
.stem:[ii(lambda) ~~ 543" "rm(nm)] ^127^I~2~ R(106) 28-0
|===
| stem:[b_n] | stem:[[f (b_n) – f (b_(10))\]//rm(MHz)] | stem:[u_c//rm(MHz)] | stem:[b_n] | stem:[[f (b_n) – f (b_(10))\]//rm(MHz)] | stem:[u_c//rm(MHz)]

| stem:[b_1] | –573.765 | stem:[0.005] | stem:[b_9] | -114.575 | 0.005
| stem:[b_2] | –320.462 | stem:[0.005] | stem:[b_(10)] | stem:[0] | -
| stem:[b_3] | –291.59 | stem:[0.01] | stem:[b_(11)] | stem:[124.83] | 0.01
| stem:[b_4] | –282.143 | stem:[0.005] | stem:[b_(12)] | stem:[132.31] | 0.01
| stem:[b_5] | –253.675 | stem:[0.005] | stem:[b_(13)] | stem:[154.51] | 0.01
| stem:[b_6] | –172.693 | stem:[0.005] | stem:[b_(14)] | stem:[162.65] | 0.01
| stem:[b_7] | –159.428 | stem:[0.005] | stem:[b_(15)] | stem:[287.24] | 0.01
| stem:[b_8] | –127.760 | stem:[0.005] | | |
6+a| Frequency referenced to::
stem:[b_(10)], R(106) 28-0, ^127^I~2~: stem:[f = 551580162400" "rm(kHz)] <<ci2003>>
|===
Ref. <<chartier1986>>, <<glaser>>, <<chartier1989>>, <<simonsen1990>>, <<fredin>>, <<lin>>, <<simonsen1994>>
