= Recommended Values of Standard Frequencies: Mercury 199 Atom (stem:[f ~~ 1129" "rm(THz)])
:appendix-id: 2
:partnumber: 2.3
:edition: 9
:copyright-year: 2019
...
*^199^Hg neutral atom, stem:[6rm(s)^2" "^1rm(S)_0 - 6rm(s)6rm(p)" "^3rm(P)_0] unperturbed optical transition*

== Recommended value <<cctf-report>> of the frequency in the CIPM List of Frequencies <<ci2006>>

stem:[f (""^199 rm(Hg)) = 1128575290808154.4 " "rm(Hz)]

equivalent to

stem:[ii(lambda) (""^199 rm(Hg)) = 265637977.7598387 " "rm(fm)],
...
The adopted value of stem:[f(""^199 Hg) = 1128575290808154.4 rm(Hz)]
...
|===
| Frequency / Hz h| Uncertainty / Hz h| Reference
