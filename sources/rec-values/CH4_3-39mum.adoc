...
*Absorbing molecule stem:[ii(CH)_4, ii(F)_2^("(2)")] component, P(7) stem:[nu_3] transition*
...
* [[[felder9,9]]], Felder R., A Decade of Work on the Determination of the Frequency of stem:[ii(F)_2^2] Methane Transition at stem:[lambda ~~ 3.39" "mu"m"], _Rapport BIPM_, 1992, *92/8*.
