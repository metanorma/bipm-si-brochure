...
h| stem:[n] h| laser line h| line h| [isotope] h| [stem:[f_n − f {R(10)}] stem:[//"unitsml(kHz)"]] h| stem:[u_c] stem:[//"unitsml(kHz)"] h| [stem:[ f ("OsO"_{4})] stem:[−f ("CO"_{2}) //"unitsml(kHz)"]] h| stem:[u_c] stem:[//"unitsml(kHz)"]
