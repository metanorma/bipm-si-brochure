= Recommended Values of Standard Frequencies: Osmium tetroxide (stem:[ii(lambda) ~~ 10.3" "mu rm(m)])
:appendix-id: 2
:partnumber: 2.26
:edition: 9
:copyright-year: 2003
...
|===
| h| stem:[""^12 "C"^{16} "O"_2] h| stem:[rm(OsO)_4] | | | | |
h| stem:[n] h| laser line h| line h| [isotope] h| [stem:[f_n − f {R(10)}] stem:[//rm(kHz)]] | stem:[u_c] stem:[//rm(kHz)] h| [stem:[ f (rm(OsO)_{4})] stem:[−f (rm(CO)_{2}) //rm(kHz)]] h| stem:[u_c] stem:[//rm(kHz)]
