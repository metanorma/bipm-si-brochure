...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Ytterbium 171 Atom (stem:[f ~~ 518" THz"])
:title-appendix-fr:
...
[align=left]
_F_(^171^Yb) stem:[= 518295836590863.6 " Hz"]

equivalent to

stem:[lambda](^171^Yb) stem:[= 578419575.916163 " fm"],
