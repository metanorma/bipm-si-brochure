...
_f_(^88^Sr) = 429 228 066 418 007.0 Hz

equivalent to

stem:[lambda](^88^Sr) = 698 445 608.419 382 fm,

with a relative standard uncertainty of stem:[6 xx 10^(−16)].

=== Source data

The adopted value of _f_(^88^Sr) = 429 228 066 418 007.0 Hz with a relative standard uncertainty of stem:[6 xx 10^(−16)]
