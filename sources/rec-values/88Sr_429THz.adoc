...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Strontium 88 Atom (stem:[f ~~ 429" "rm(THz)])
:title-appendix-fr:
...
== Strontium 88 Atom (stem:[f ~~ 429" "rm(THz)])

*^88^Sr neutral atom, 5s^2^ ^1^S~0~ – 5s5p ^3^P~0~ unperturbed optical transition*

=== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies

stem:[f](^88^Sr) stem:[= 429228066418007.0 " "rm(Hz)]

equivalent to

stem:[ii(lambda)](^88^Sr) stem:[= 698445608.419382 " "rm(fm)],

with a relative standard uncertainty of stem:[6 xx 10^(−16)].

=== Source data

The adopted value of stem:[f](^88^Sr) stem:[= 429228066418007.0 " "rm(Hz)] with a relative standard uncertainty of stem:[6 xx 10^(−16)]
