...
stem:[f text()^171 Yb^+^, octupole = 642121496772645.0 " "rm(Hz)]

equivalent to

stem:[ii(lambda) text()^171 Yb^+^ = 466878090.060497 " "rm(fm)]
...
[align=left]
Adopted value:: stem:[f text()^171 Yb^+^, octupole = 642121496772645.0" "rm(Hz)] +
