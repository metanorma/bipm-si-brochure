...
*^171^Yb^+^ ion, stem:[6rm(s)" "^2rm(S)_{1//2} - 5rm(d)" "^2rm(D)_{3//2}] unperturbed optical transition*
...
[cols="<,^,^,^,^"]
|===
h| f (^171^Yb^+^, quadrupole) / Hz h| u / Hz h| f(^171^Yb^\+^ oct)/ f(^171^Yb^+^ quad) h| u h| source data
