...
:title-appendix-en: Recommended Values of Standard Frequencies for Applications Including the Practical Realization of the Metre and Secondary Representations of the Definition of the Second: Iodine (stem:[lambda ~~ 633" nm"]) (2003)
:title-appendix-fr:
...
[align=left]
The values:: stem:[f = 473612353604" kHz"] +
stem:[lambda = 632991212.58" fm"]
...
[align=left]
Adopted value:: stem:[f = 473612353604(10)" kHz"] +
stem:[u_c//y = 2.1 xx 10^(-11)]

[align=left]
for which:: stem:[lambda = 632991212.579(13)" fm"] +
stem:[u_c//y = 2.1 xx 10^(-11)]
...
[align=left]
Sugiyama et al. <<shen>> give:: stem:[f_f = 473612353604.3" kHz"] +
stem:[u_c = 1.7" kHz"] +
...
stem:[a_(16)" (f), R(127) 11-5"], ^127^I~2~: stem:[f = 473612353604" kHz"] <<ci2002>>
|===
...
8+a| Frequency referenced to::
stem:[a_(16)" (f), R(127) 11-5"], ^127^I~2~: stem:[f = 473612353604" kHz"] <<ci2002>> +
stem:[f (a_(28)," P(54) 8-4") – f (a_(16)," R(127) 11-5"{^(127)ii(I)_2}) = –42.99(4)" MHz"] <<ccdm82-2>>, <<chartier1984>>
|===
