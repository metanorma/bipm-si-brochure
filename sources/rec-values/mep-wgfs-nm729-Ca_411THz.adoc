= Recommended Values of Standard Frequencies: Calcium 40 Ion (stem:[f ~~ 411"unitsml(THz)"])
:appendix-id: 2
:partnumber: 2.22
:edition: 9
:copyright-year: 2019
:language: en
:docnumber: SI MEP M REC 411THz
:title-appendix-en: Recommended values of standard frequencies for applications including the practical realization of the metre and secondary representations of the second
:title-appendix-fr: Valeurs recommandées des fréquences étalons destinées à la mise en pratique de la définition du mètre et aux représentations secondaires de la seconde
:title-part-en: Calcium 40 Ion (stem:[f ~~ 411"unitsml(THz)"])
:title-part-fr: Calcium 40 Ion (stem:[f ~~ 411"unitsml(THz)"])
...
== Calcium 40 Ion (stem:[f ~~ 411"unitsml(THz)"])

*^40^Ca^+^, stem:[4s" "^2"S"_{1//2} - 3"unitsml(d)"" "^2"D"_{5//2}] unperturbed optical transition*

== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies <<ci2006>>

stem:[f (""^40 rm(Ca)^"+") = 411042129776399.8 "unitsml(Hz)"]

equivalent to

stem:[ii(lambda)^40 rm(Ca)^"+" = stem:[729347276.793944 "unitsml(fm)"],

with a relative standard uncertainty of stem:[2.4 xx 10^(−15)].

== Source data

The adopted value of stem:[f](^40^Ca^+^) = stem:[411042129776399.8 "unitsml(Hz)"] with a relative standard uncertainty of stem:[2.4 xx 10^(−15)]

has been calculated by the methods presented in <<margolis>>, <<robertsson>>, <<oates>>, <<riehle>>, with the data from the table of frequencies (2017) attached below. Since the frequency and the associated uncertainty of ref. <<chwalla>> is not compatible with the other data, the uncertainty given in the original publication was increased to stem:[3 "unitsml(Hz)"] to make it statistically more consistent. This value has very little effect, and so the recommended frequency value comes essentially only from measurements made by two labs. Thus, the final uncertainty has been increased by a factor of two following the procedures outlined in ref. <<riehle>>.
