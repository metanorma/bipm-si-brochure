...
:title-part-en: Calcium 40 Ion (stem:[f ~~ 411" "rm(THz)])
:title-part-fr: Calcium 40 Ion (stem:[f ~~ 411" "rm(THz)])
...
*^40^Ca^+^, stem:[4s" "^2rm(S)_{1//2} - 3rm(d)" "^2rm(D)_{5//2}] unperturbed optical transition*

== Recommended value <<cctf21>> of the frequency in the CIPM List of Frequencies <<ci2006>>

stem:[f ""^40 rm(Ca)^"+" = 411042129776399.8 " "rm(Hz)]

equivalent to

stem:[ii(lambda)^40 rm(Ca)^"+" = stem:[729347276.793944 " "rm(fm)],
