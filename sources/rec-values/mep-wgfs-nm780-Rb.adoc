...
stem:[f(""^87rm(Rb)_{rm(d//f" "crossover)}) = 384227981.9" "rm(MHz)]

equivalent to

stem:[ii(lambda)(""^87rm(Rb)_{rm(d//f" "crossover)}) = 780246291.6" "rm(fm)],
...
[%unnumbered]
|===
| stem:[f(""^87rm(Rb)_{rm(d//f" "crossover)}) // rm(kHz)] | stem:[u_c//y] | source data
