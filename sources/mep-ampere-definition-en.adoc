...
Note that the value of stem:[K_"J"] in <<eq-1>> is smaller than the value stem:[K_{"J-90"} = 483597.9 " GHz V"^{-1}], which was
...
[stem]
++++
R_"K" = 25812.8074593045 text( ) Omega
++++
...
Note that the value of stem:[R_"K"] in <<eq-2>> is larger than the value stem:[R_{"K-90"} = 25812.807 text( ) Omega], which was adopted
