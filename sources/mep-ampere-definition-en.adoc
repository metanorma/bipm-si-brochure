...
The volt stem:[rm(V)] can be realized using the Josephson effect and the following value of the Josephson constant stem:[ii(K)_"J"]:
...
The siemens stem:[rm(S)] can be realized from a realization of the ohm (see <<sec-5>>) since stem:[rm(S)] is related to stem:[Omega] by the
...
[stem]
++++
u_"r" (ii(Y)_0) = u_"r" (ii(Z)_0) = u_"r" (ii(epsilon)_0) = u_"r" (u_0) = u_"r" (ii(alpha))
++++
...
* [[[newell,3]]] D. Newell, F. Cabiati, J. Fischer, K. Fujii, S. G. Karshenboim, H. S. Margolis, E. de Mirandes, P.J. Mohr, F. Nez, K. Pachucki, T. J. Quinn, B. N. Taylor, M. Wang, B. Wood and Z. Zhang, ‘The CODATA 2017 Values of stem:[h], stem:[e], stem:[k], and stem:[ii(N)_"A"] for the Revision of the SI’, Metrologia, 55(1) L13-L16 (2018).
