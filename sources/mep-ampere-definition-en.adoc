...
____
The ampere, symbol A, is the SI unit of electric current. It is defined by taking the fixed numerical value of the elementary charge stem:[e] to be stem:[1.602 176 634 xx 10^{-19}] when expressed in the unit stem:["C"], which is equal to stem:["A s"], where the second is defined in terms of stem:[Delta nu_{"Cs"}].
____
...
= 12.566" "370" "6169(29) xx 10^{-7} " N A"^{-2}
++++
...
* [[[newell,3]]] D. Newell, F. Cabiati, J. Fischer, K. Fujii, S. G. Karshenboim, H. S. Margolis, E. de Mirandes, P.J. Mohr, F. Nez, K. Pachucki, T. J. Quinn, B. N. Taylor, M. Wang, B. Wood and Z. Zhang, ‘The CODATA 2017 Values of stem:[h], stem:[e], stem:[k], and stem:[N_A] for the Revision of the SI’, Metrologia, 55(1) L13-L16 (2018).
