...
[.variant-title,type=quoted]
*Déclaration relative à l’unité de masse et à la définition du poids{nbsp}; valeur conventionnelle de stem:[g_{"n"}]* (<<CR70>>) ((("accélération due à la pesanteur "(stem:[g_{"n"}])))) (((masse))) (((masse et poids)))
