...
*Pascal et siemens* (<<CR1971-2,page=78>>) (((pascal (stem:["unitsml(Pa)"]))))(((siemens (stem:["unitsml(S)"]))))(((unité(s),ayant des noms spéciaux et des symboles particuliers)))
...
[.variant-title,type=quoted]
*Temps atomique international{nbsp}; rôle du CIPM* (<<CR1971-1,page=77>>-<<CR1971-1,page=78>> et _Metrologia_, 1972, *8*, 35) index-range:temps_tai[(((temps,atomique international (TAI))))]
...
[.variant-title,type=quoted]
*Unité SI de quantité de matière (mole)* (<<CR1971-2,page=78>> et _Metrologia_, 1972, *8*, 36)(((mole (stem:["unitsml(mol)"]))))(((quantité de matière)))
