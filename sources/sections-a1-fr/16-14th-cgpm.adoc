...
. de donner une définition du Temps atomique international; footnote:[La définition du TAI a été donnée par le CCDS en 1970 (maintenant renommé CCTF), _voir_ <<ccds-tai-definition_s2,Recommandation S 2>>]
