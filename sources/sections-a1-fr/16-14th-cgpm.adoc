...
. de donner une définition du Temps atomique international; footnote:[La définition du TAI a été donnée par le CCDS en 1970 (maintenant renommé CCTF),
_voir_ p. 61.]
...
par la CGPM à sa 26^e^ réunion en 2018
