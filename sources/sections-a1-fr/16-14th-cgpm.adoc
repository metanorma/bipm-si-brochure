...
newton(((newton (N)))) par mètre carré et «{nbsp}siemens{nbsp}» (symbole S) pour l’unité SI de conductance électrique
(ohm(((ohm (stem:[Omega])))) à la puissance moins un).
____

[[cgpm14e1971r1]]
=== Temps atomique international{nbsp}; rôle du CIPM (CR, 77-78 et _Metrologia_, 1972, 8, 35) index-range:temps_tai[(((temps,atomique international (TAI))))]
