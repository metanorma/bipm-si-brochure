...
* la masse molaire du carbone 12 M(^12^C) sera égale à stem:[0.012] stem:["kg mol"^{-1}], avec cependant une
...
* la masse molaire du carbone 12, M(^12^C), est égale à stem:[0.012] stem:["kg mol"^{-1}] avec une incertitude-type
