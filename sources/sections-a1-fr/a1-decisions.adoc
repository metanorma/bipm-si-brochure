...
==== Déclaration relative à l’unité de masse et à la définition du poids{nbsp}; valeur conventionnelle de stem:[g_n] (CR, 70)
...
candela(((candela (cd)))) donné à la «{nbsp}bougie nouvelle{nbsp}» (CR, 54). Pour le
...
==== Point triple de l’eau{nbsp}; échelle thermodynamique à un seul point fixe{nbsp}; unité de quantité de chaleur (joule) (CR, 55 et 63)
...
==== Adoption de «{nbsp}degré Celsius{nbsp}» [CIPM, 1948 (PV, 21, 88) et 9^e^ CGPM, 1948 (CR, 64)]

Entre les trois termes («{nbsp}degré centigrade{nbsp}», «{nbsp}degré centésimal{nbsp}», «{nbsp}degré Celsius{nbsp}») proposés
pour désigner le degré de température, le Comité international a choisi «{nbsp}degré Celsius{nbsp}» (PV,
*21*, 88).
...
. L’unité de volume stère, employée dans le mesurage des bois, aura pour symbole «{nbsp}st{nbsp}» et
...
NOTE: Le nom «{nbsp}becquerel{nbsp}»(((becquerel (Bq)))) (Bq) a été adopté par la
...
demandant que l’emploi des symboles «{nbsp}°K{nbsp}» et
...
* les noms «{nbsp}degré Kelvin{nbsp}» et «{nbsp}degré{nbsp}», les symboles «{nbsp}°K{nbsp}» et «{nbsp}deg{nbsp}» et leurs règles d’emploi
...
*décide* d’exprimer la définition de la candela(((candela (cd)))) de la façon suivante{nbsp}:

«{nbsp}La candela(((candela (cd)))) est l’intensité lumineuse, dans la direction perpendiculaire, d’une surface de
...
La 14^e^ Conférence générale a adopté les noms spéciaux «{nbsp}pascal{nbsp}» (symbole Pa) pour l’unité SI
newton par mètre carré et «{nbsp}siemens{nbsp}» (symbole S) pour l’unité SI de conductance électrique
(ohm à la puissance moins un).


==== Temps atomique international{nbsp}; rôle du CIPM (CR, 77-78 et _Metrologia_, 1972, 8, 35)
...
y a d’atomes dans stem:[0.012] kilogramme de carbone 12{nbsp}; son symbole est «{nbsp}mol{nbsp}».
+
--
...
==== «{nbsp}unités SI{nbsp}» et «{nbsp}unités du SI{nbsp}» (PV, 69, 38-39)
...
plane pendant la durée t{nbsp}; cette longueur est obtenue à partir de la mesure de la durée t, en
...
* la valeur mise à jour de la fréquence de l’étalon asservi sur l’acétylène à stem:[1.54] stem:[mu rm(m)]{nbsp};
...
* la valeur mise à jour de la fréquence de l’étalon asservi sur l’acétylène à stem:[1.54] stem:[mu rm(m)]{nbsp};
* la valeur mise à jour de la fréquence de l’étalon asservi sur l’iode à 515 nm{nbsp};
* la fréquence de la transition de l’atome de ^87^Sr à 698 nm{nbsp};
* les fréquences des transitions de l’atome de ^87^Rb autour de 760 nm{nbsp};
...
532 nm, à l’aide de peignes à impulsions femtosecondes{nbsp};

*propose* que la liste des fréquences étalons soit révisée pour y inclure{nbsp}:

* les valeurs mises à jour des fréquences de la bande (stem:[nu_1 + nu_3]) de ^12^C~2~H~2~, autour de stem:[1.54] stem:[mu rm(m)]{nbsp};

* les valeurs des fréquences de la bande (stem:[2_{nu1}]) de ^12^C~2~HD, autour de stem:[1.54] stem:[mu rm(m)]{nbsp};
...
stem:[f = 411042129776393] stem:[rm(Hz)], avec une incertitude-type relative de stem:[4 xx 10^{-14}]{nbsp};

* la transition optique non perturbée ^2^S~1/2~ (F = 0) – ^2^F~7/2~ (F = 3, ~mF~ = 0) de l’ion de ^171^Yb^+^, à la
fréquence de stem:[f = 642121496772657] stem:[rm(Hz)], avec une incertitude-type relative de stem:[6 xx 10^{-14}]{nbsp};
...
CGPM, 1889{nbsp}; 3^e^ réunion de la CGPM, 1901), et que les définitions de l’ampère(((ampère (A)))), de la mole et
...
* la seconde, symbole s, est l’unité de temps{nbsp}; son amplitude est déterminée en fixant la valeur
...
* le mètre, symbole m, est l’unité de longueur{nbsp}; son amplitude est déterminée en fixant la valeur
...
* la candela(((candela (cd)))), symbole cd, est l’unité d’intensité lumineuse dans une direction donnée{nbsp}; son
...
* la transition optique non perturbée 4s ^2^S~1/2~ – 3d ^2^D~5/2~ de l’ion de ^40^Ca^+^, à la fréquence de
stem:[f_{40Ca+} = 411042129776398.4] stem:[rm(Hz)] avec une incertitude-type relative estimée de stem:[1.2 xx 10^{-14}]{nbsp};
* la transition optique non perturbée 1S – 2S de l’atome neutre de ^1^H, à la fréquence de f~1H~ = 1
stem:[233030706593514 " "rm(Hz)] avec une incertitude-type relative estimée de stem:[9 xx 10^{-15}]{nbsp};
