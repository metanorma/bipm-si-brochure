...
valeur de stem:[483597.9 " "rm(GHz)//rm(V)] pour la constante de Josephson, stem:[ii(K)_J], c’est-à-dire pour le quotient de
...
* que l’on adopte, par convention, pour la constante de Josephson, stem:[ii(K)_J], la valeur
...
et reproductible,
* qu’une étude approfondie des résultats des déterminations les plus récentes conduit à une
valeur de stem:[25812.807 Omega] pour la constante de von Klitzing, stem:[ii(R)_K], c’est-à-dire pour le quotient de la
...
international à la constante de Planck, stem:[h], ou à la constante d’Avogadro, stem:[ii(N)_"A"],
...
dans le SI des constantes de Josephson et de von Klitzing, stem:[ii(K)_J] et stem:[ii(R)_K], pourraient être réduites de
...
* les valeurs conventionnelles de la constante de Josephson stem:[ii(K)_{J–90}] et de la constante de von
...
la constante de von Klitzing stem:[ii(R)_{K–90}], prise par le CIPM (1988, Recommandations 1 et 2)
