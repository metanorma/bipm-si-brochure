...
==== Sanction des prototypes internationaux du mètre et du kilogramme (<<CR34>>-<<CR38>>)
...
==== Déclaration concernant la définition du litre (<<CR38>>-<<CR39>>)
...
==== Déclaration relative à l’unité de masse et à la définition du poids{nbsp}; valeur conventionnelle de stem:[g_{"n"}] (<<CR70>>)
...
==== Point triple de l’eau{nbsp}; échelle thermodynamique à un seul point fixe{nbsp}; unité de quantité de chaleur (joule) (<<CR55>> et <<CR63>>)
...
==== Adoption de «{nbsp}degré Celsius{nbsp}» [CIPM, 1948 (<<PV21, page=88>>) et 9^e^ CGPM, 1948 (<<CR64>>)]
...
Ce terme est également adopté par la 9^e^ Conférence générale (<<CR64>>).


==== Proposition d’établissement d’un système pratique d’unités de mesure (<<CR64>>)
...
==== Écriture des symboles d’unités et des nombres (<<CR70>>)
...
==== Définition de l’échelle thermodynamique de température (<<CR79>>)
...
==== Définition de l’atmosphère normale (<<CR79>>)
...
==== Système pratique d’unités de mesure (<<CR80>>)
...
==== Définition de l’unité de temps (seconde) (<<CR86>>)
...
==== Système international d’unités (<<CR87>>)
...
==== Étalon atomique de fréquence (<<CR93>>)
...
==== Préfixes SI femto et atto (<<CR94>>)
...
==== Unité SI de temps (seconde) (<<CR103>> et _Metrologia_, 1968, 4, 43)
...
==== Unité SI de température thermodynamique (kelvin) (<<CR104>> et _Metrologia_, 1968, 4, 43)
...
==== Définition de l’unité SI de température thermodynamique (kelvin) (<<CR104>> et _Metrologia_, 1968, 4, 43)*
...
==== Unité SI d’intensité lumineuse (candela(((candela (stem:["unitsml(cd)"]))))) (<<CR104>> et _Metrologia_, 1968, 4, 43-44)
...
==== Unités SI dérivées (<<CR105>> et _Metrologia_, 1968, 4, 44)
...
==== Abrogation de décisions antérieures (micron et bougie nouvelle) (<<CR105>> et _Metrologia_, 1968, 4, 44)
...
==== Temps atomique international{nbsp}; rôle du CIPM (<<CR77>>-<<CR78>> et _Metrologia_, 1972, 8, 35)
...
==== Unité SI de quantité de matière (mole) (<<CR78>> et _Metrologia_, 1972, 8, 36)
...
==== Temps universel coordonné (UTC) (<<CR104>> et _Metrologia_, 1975, 11, 180)
...
==== Préfixes SI péta et exa (<<CR106>> et _Metrologia_, 1975, 11, 180-181)
...
==== Unité SI d’intensité lumineuse (candela(((candela (stem:["unitsml(cd)"]))))) (<<CR100>> et _Metrologia_, 1980, 16, 56)
...
==== Nom spécial pour l’unité SI d’équivalent de dose (sievert) (<<CR100>> et _Metrologia_, 1980, 16, 56)
...
==== Définition du mètre (<<CR97>> et _Metrologia_, 1984, 20, 25)
...
==== Sur la mise en pratique de la définition du mètre (<<CR98>> et _Metrologia_, 1984, 20, 25-26)
...
==== Ajustement prévu des représentations du volt et de l’ohm (<<CR100>> et _Metrologia_, 1988, 25, 115)
...
==== Préfixes SI zetta, zepto, yotta et yocto (<<CR97>> et _Metrologia_, 1992, 29, 3)
...
=== Suppression de la classe des unités supplémentaires dans le SI (<<CR121>> et _Metrologia_, 1996, 33, 83)
...
==== La définition du kilogramme (<<CR141>>-<<CR142>> et _Metrologia_, 2000, 37, 94)
...
==== Nom spécial donné à l'unité SI mole par seconde, le katal, pour exprimer l'activité catalytique (<<CR145>> et _Metrologia_, 2000, 37, 95)
...
==== Symbole du séparateur décimal (<<CR169>> et _Metrologia_, 2004, 41, 104)
...
==== Sur la révision de la mise en pratique de la définition du mètre et sur la mise au point de nouveaux étalons optiques de fréquence (<<CR171>>)
...
==== Sur la clarification de la définition du kelvin, unité de température thermodynamique (<<CR172>>)
...
==== Sur l’éventuelle redéfinition de certaines unités de base du Système international d’unités (SI) (<<CR174>>)
...
==== Sur l’éventuelle révision à venir du Système international d’unités, le SI (<<CR212>>)
...
==== Sur la révision de la mise en pratique de la définition du mètre et sur la mise au point de nouveaux étalons optiques de fréquence (<<CR227>>)
