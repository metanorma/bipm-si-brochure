...
| force | newton | stem:["N"] | stem:["kg" cdot "m/s"^2]
| pression (tension mécanique) | newton par mètre carré | stem:["N/m"^2] |
| viscosité cinématique | mètre carré par seconde | stem:["m"^2//"s"] |
| viscosité dynamique | newton-seconde par mètre carré | stem:[N cdot "s/m"^2] |
| travail, énergie, quantité de chaleur | joule | stem:["J"] | stem:["N" cdot "m"]
| puissance | watt | stem:["W"] | stem:["J/s"]
| quantité d’électricité | coulomb | stem:["C"] | stem:["A" cdot "s"]
...
| capacité électrique | farad | stem:["F"] | stem:["A" cdot "s/V"]
| flux d’induction magnétique | weber | stem:["Wb"] | stem:["V" cdot "s"]
| inductance | henry | stem:["H"] | stem:["V" cdot "s/A"]
...
| flux lumineux | lumen | stem:["lm"] | stem:["cd" cdot "sr"]
...
| chaleur massique | joule par kilogramme kelvin | stem:["J"//("kg" cdot "K")]
| conductivité thermique | watt par mètre kelvin | stem:["W"//("m" cdot "K")]
...
élevées (stem:["L" >] environ stem:[10] stem:["cd m"^{-2}]), qui
...
mesures, dans sa Résolution 2 (stem:[c = 299792458 " m/s"]),
...
valeur de stem:[483597.9 " GHz/V"] pour la constante de Josephson, stem:[K_J], c’est-à-dire pour le quotient de
...
stem:[K_{J-90} = 483597.9] stem:["GHz/V"] exactement,
...
et reproductible,
* qu’une étude approfondie des résultats des déterminations les plus récentes conduit à une
valeur de stem:[25812.807 Omega] pour la constante de von Klitzing, stem:[R_K], c’est-à-dire pour le quotient de la
...
stem:[R_{K-90} = 25812.807 Omega] exactement,
...
fréquence de f^87^~Rb~ stem:[= 6834682610.904324 " Hz"], avec une incertitude-type relative estimée de
stem:[3 xx 10^{-15}],
* la transition optique non perturbée 5s ^2^S~1/2~ – 4d ^2^D~5/2~ de l’ion de ^88^Sr^\+^, à la fréquence de
f^88^Sr^+^ stem:[= 444779044095484 " Hz"], avec une incertitude-type relative estimée de stem:[7 xx 10^{-15}],
* la transition optique non perturbée
5d^10^ 6s ^2^S~1/2~ (stem:[F = 0]) – 5d^9^ 6s^2^ ^2^D~5/2~ (stem:[F = 2]) de l’ion de
^199^Hg^\+^, à la fréquence de f^199^Hg^+^ stem:[= 1064721609899145 " Hz"], avec une incertitude-type
...
fréquence de f^171^Yb^+^ stem:[= 688358979309308 " Hz"], avec une incertitude-type relative estimée
de stem:[9 xx 10^{-15}],
* la transition optique non perturbée 5s^2^ ^1^S0 – 5s 5p ^3^P0 de l’atome neutre de ^87^Sr, à la
fréquence de f^87^~Sr~ stem:[= 429228004229877 " Hz"], avec une incertitude-type relative estimée de
stem:[1.5 xx 10^{-14}]
...
à la fréquence de stem:[f = 429228004229873.7] stem:["Hz"], avec une incertitude-type relative de
...
à la fréquence de stem:[f = 429228066418012] stem:["Hz"], avec une incertitude-type relative de
stem:[1 xx 10^{-14}];
...
^171^Yb à la fréquence de stem:[f = 518295836590864] stem:["Hz"], avec une incertitude-type relative de
stem:[1.6 xx 10^{-13}].
...
133 stem:[Delta ν](^133^Cs)~hfs~ est égale à exactement 9192631770 hertz,
* la vitesse de la lumière dans le vide c est égale à exactement 299792458 mètres par seconde,
* la constante de Planck stem:[h] est égale à exactement stem:[6.62606X xx 10^{-34}] joule seconde*,
+
...
* la constante d’Avogadro stem:[N_A] est égale à exactement stem:[6.02214X xx 10^23] par mole,
...
qui ont respectivement pour symbole s, m, kg, A, K, mol, et cd, selon les relations stem:["Hz" = "s"^{-1}],
...
stem:[6.62606X xx 10^{-34}] lorsqu’elle sera exprimée en stem:["m"^2 "kg s"^{-1}], unité du SI égale au joule
seconde, stem:["J s"],
...
stem:[1.60217X xx 10^{-19}] lorsqu’elle sera exprimée en stem:["s A"], unité du SI égale au coulomb, stem:["C"],
...
exactement stem:[1.3806X xx 10^{-23}] lorsqu’elle sera exprimée en stem:["m"^2 "kg s"^{-2} "K"^{-1}], unité du SI
...
exprimée en stem:["s"^{-1}], unité du SI égale au hertz, Hz,
...
* la température thermodynamique du point triple de l’eau TTPW sera égale à stem:[273.16 " K"], avec
cependant une incertitude relative égale à celle de la valeur recommandée de k juste avant la
redéfinition, puis sa valeur sera déterminée de façon expérimentale,

* la masse molaire du carbone stem:[12 " " M(""^{12}"C")] sera égale à stem:[0.012] stem:["kg mol"^{-1}], avec cependant une
...
exactes de la constante de Planck stem:[h], de la charge élémentaire stem:[e], de la constante de Boltzmann stem:[k],
...
à la fréquence de f199Hg = stem:[1128575290808154.8 " Hz"] avec une incertitude-type relative
...
de stem:[f_{171Yb+}] (octupôle) = stem:[642121496772645.0 " Hz"] avec une incertitude-type relative estimée
...
de 171Yb+, à la fréquence de f171Yb+ (quadripôle) stem:[= 688358979309308.3 " Hz"] avec une
...
* la transition optique non perturbée 5s ^2^S~1/2~ – 4d ^2^D~5/2~ de l’ion de ^88^Sr^+^, à la fréquence de
f88Sr+ = stem:[444779044095486.6 " Hz"] avec une incertitude-type relative estimée de stem:[1.6 xx 10^{-15}]
(cette radiation a déjà été approuvée par le CIPM comme représentation secondaire de la
seconde);

* la transition optique non perturbée 4s ^2^S~1/2~ – 3d ^2^D~5/2~ de l’ion de ^40^Ca^+^, à la fréquence de
stem:[f_{40Ca+} = 411042129776398.4] stem:["Hz"] avec une incertitude-type relative estimée de stem:[1.2 xx 10^{-14}];
* la transition optique non perturbée 1S – 2S de l’atome neutre de ^1^H, à la fréquence de f~1H~ = 1
stem:[233030706593514 " Hz"] avec une incertitude-type relative estimée de stem:[9 xx 10^{-15}];

Remarque: cette fréquence correspond à la moitié de l’écart en énergie entre les états 1S et
2S;

* la transition optique non perturbée 5s^2^ ^1^S~0~ – 5s5p ^3^P~0~ de l’atome neutre de ^87^Sr,
à la fréquence de stem:[f_{87Sr} = 429228004229873.2] stem:["Hz"] avec une incertitude-type relative estimée
...
à la fréquence de stem:[f_{87Rb} = 6834682610.904310] stem:["Hz"] avec une incertitude-type relative estimée
...
+
--
Les valeurs:: stem:[f_{a1} = 564074632.42] stem:["MHz"] +
stem:[lambda_{a1} = 531476582.65] stem:["fm"]
--
...
+
--
Les valeurs:: stem:[f_{"croisement d/f"} = 384227981.9] stem:["MHz"] +
stem:[lambda_{"croisement d/f"} = 780246291.6] stem:["fm"]
--
...
133 non perturbé, stem:[Delta ν_{Cs}], est égale à stem:[9192631770 " Hz"],
...
* la charge élémentaire, stem:[e], est égale à stem:[1.602176634 xx 10^{-19}] stem:["C"],
...
lm et W, sont reliées aux unités seconde, mètre, kilogramme, ampère, kelvin, mole et candela,
qui ont respectivement pour symbole s, m, kg, A, K, mol et cd, selon les relations, stem:["J" = "kg m"^2 "s"^{-2}],
...
est abrogée,
* la décision d’adopter les valeurs conventionnelles de la constante de Josephson stem:[K_{J–90}] et de
la constante de von Klitzing stem:[R_{K–90}], prise par le CIPM (1988, Recommandations 1 et 2)
...
* la température thermodynamique du point triple de l’eau, TTPW, est égale à stem:[273.16 K " K"] avec
...
* la masse molaire du carbone 12, stem:[M(""^{12}"C")], est égale à stem:[0.012] stem:["kg mol"^{-1}] avec une incertitude-type
