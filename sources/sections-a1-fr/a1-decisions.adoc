...
candela(((candela (stem:["unitsml(cd)"])))) donné à la «&nbsp;bougie nouvelle&nbsp;» (CR, 54). Pour le
...
. L’unité de volume stère, employée dans le mesurage des bois, aura pour symbole «&nbsp;stem:["unitsml(st)"]&nbsp;» et
...
NOTE: Le nom «&nbsp;becquerel&nbsp;»(((becquerel (stem:["unitsml(Bq)"])))) (Bq) a été adopté par la
...
demandant que l’emploi des symboles «&nbsp;stem:["unitsml(degK)"]&nbsp;» et
...
* les noms «&nbsp;degré Kelvin&nbsp;» et «&nbsp;degré&nbsp;», les symboles «&nbsp;stem:["unitsml(degK)"]&nbsp;» et «&nbsp;deg&nbsp;» et leurs règles d’emploi
...
==== Unité SI d’intensité lumineuse (candela(((candela (stem:["unitsml(cd)"]))))) (CR, 104 et _Metrologia_, 1968, 4, 43-44)
...
*décide* d’exprimer la définition de la candela(((candela (stem:["unitsml(cd)"])))) de la façon suivante:

«&nbsp;La candela(((candela (stem:["unitsml(cd)"])))) est l’intensité lumineuse, dans la direction perpendiculaire, d’une surface de
...
| chaleur massique | joule par kilogramme kelvin | stem:["unitsml(J)"//("unitsml(kg*K)")]
| conductivité thermique | watt par mètre kelvin | stem:["unitsml(W)"//("unitsml(m*K)")]
...
newton par mètre carré et «&nbsp;siemens&nbsp;» (symbole stem:["unitsml(S)"]) pour l’unité SI de conductance électrique
...
y a d’atomes dans stem:[0.012] kilogramme de carbone 12; son symbole est «&nbsp;stem:["unitsml(mol)"]&nbsp;».
+
--
...
==== Unités SI pour les rayonnements ionisants (becquerel(((becquerel (stem:["unitsml(Bq)"])))) et gray) (CR, 105 et _Metrologia_, 1975, 11, 180)
...
==== Unité SI d’intensité lumineuse (candela(((candela (stem:["unitsml(cd)"]))))) (CR, 100 et _Metrologia_, 1980, 16, 56)
...
* la valeur mise à jour de la fréquence de l’étalon asservi sur l’acétylène à stem:[1.54 "unitsml(um)"];
...
stem:[532 "unitsml(nm)"], à l’aide de peignes à impulsions femtosecondes;

*propose* que la liste des fréquences étalons soit révisée pour y inclure:

* les valeurs mises à jour des fréquences de la bande (stem:[ii(nu)_1 + ii(nu)_3]) de ^12^C~2~H~2~, autour de stem:[1.54"unitsml(um)"];

* les valeurs des fréquences de la bande (stem:[2_{ii(nu)_1}]) de ^12^C~2~HD, autour de stem:[1.54"unitsml(um)"];
...
CGPM, 1889; 3^e^ réunion de la CGPM, 1901), et que les définitions de l’ampère(((ampère (stem:["unitsml(A)"])))), de la mole et
...
* le mètre, symbole stem:["unitsml(m)"], est l’unité de longueur; son amplitude est déterminée en fixant la valeur
