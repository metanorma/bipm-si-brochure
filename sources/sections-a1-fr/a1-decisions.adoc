...
a| &#x2022; mètre | stem:["unitsml(m)"] | ampère(((ampère (A)))) | stem:["unitsml(A)"]
...
| degré Celsius | stem:["unitsml(°C)"] a| &#x2022; candela(((candela (cd)))) (bougie nouvelle) | stem:["unitsml(cd)"]
a| &#x2022; degré absolu | stem:["unitsml(°K)"] | lux | stem:["unitsml(lx)"]
...
| travail, énergie, quantité de chaleur | joule | stem:["unitsml(J)"] | stem:["unitsml(N)" * "unitsml(m)"]
| puissance | watt | stem:["unitsml(W)"] | stem:["unitsml(J//s)"]
| quantité d’électricité | coulomb | stem:["unitsml(C)"] | stem:["unitsml(A)" * "unitsml(s)"]
| tension électrique, différence de potentiel, force électromotrice | volt(((volt (V)))) | stem:["unitsml(V)"] | stem:["unitsml(W//A)"]
| intensité de champ électrique | volt(((volt (V)))) par mètre | stem:["unitsml(V//m)"] |
| résistance électrique | ohm | stem:[Omega] | stem:["unitsml(V//A)"]
| capacité électrique | farad | stem:["unitsml(F)"] | stem:["unitsml(A)" * "unitsml(s//V)"]
| flux d’induction magnétique | weber | stem:["unitsml(Wb)"] | stem:["unitsml(V)" * "unitsml(s)"]
| inductance | henry | stem:["unitsml(H)"] | stem:["unitsml(V)" * "unitsml(s//A)"]
...
| flux lumineux | lumen | stem:["unitsml(lm)"] | stem:["unitsml(cd)" * "unitsml(sr)"]
...
| chaleur massique | joule par kilogramme kelvin | stem:["unitsml(J)"//("unitsml(kg)" * "unitsml(K)")]
| conductivité thermique | watt par mètre kelvin | stem:["unitsml(W)"//("unitsml(m)" * "unitsml(K)")]
...
et reproductible,
* qu’une étude approfondie des résultats des déterminations les plus récentes conduit à une
valeur de stem:[25812.807" ""unitsml(Omega)"] pour la constante de von Klitzing(((constante, de von Klitzing (stem:[ii(R)_"K"], stem:[ii(R)_"K-90"])))), stem:[ii(R)_K], c’est-à-dire pour le quotient de la
...
stem:[1] stem:[mu "unitsml(mol)" * "unitsml(min^{-1})"], et qui n'est pas cohérente avec le SI, a été largement répandue en médecine et
...
plane pendant la durée t; cette longueur est obtenue à partir de la mesure de la durée stem:[t], en
...
à dioxyde de carbone asservis sur le tétroxyde d’osmium à stem:[10] stem:[mu "unitsml(m)"],
...
(stem:[ii(nu)_1 + ii(nu)_3 + ii(nu)_4 + ii(nu)_5]) de ^13^C~2~H~2~, autour de stem:[1.54] stem:[mu "unitsml(m)"].
...
* les valeurs mises à jour des fréquences de la bande (stem:[ii(nu)_1 + ii(nu)_3]) de ^12^C~2~H~2~, autour de stem:[1.54" "mu "unitsml(m)"];

* les valeurs des fréquences de la bande (stem:[2_{ii(nu)_1}]) de ^12^C~2~HD, autour de stem:[1.54" "mu "unitsml(m)"];
...
qui ont respectivement pour symbole s, m, kg, A, K, mol, et cd, selon les relations stem:["unitsml(Hz)" = "unitsml(s^{-1})"],
...
exprimée en stem:["unitsml(s^{-1})"], unité du SI égale au hertz, Hz,
...
3), selon laquelle la masse molaire du carbone 12 a la valeur exacte de stem:[0.012] stem:["unitsml(kg mol^{-1})"], sera
abrogée,
...
* la transition optique non perturbée 4s ^2^S~1/2~ – 3d ^2^D~5/2~ de l’ion de ^40^Ca^+^, à la fréquence de
stem:[f_{40Ca+} = 411042129776398.4" ""unitsml(Hz)"] avec une incertitude-type relative estimée de stem:[1.2 xx 10^{-14}];
* la transition optique non perturbée 1S – 2S de l’atome neutre de ^1^H, à la fréquence de f~1H~ = 1
stem:[233030706593514 " ""unitsml(Hz)"] avec une incertitude-type relative estimée de stem:[9 xx 10^{-15}];
...
+
--
Les valeurs:: stem:[f_{a1} = 564074632.42] stem:["unitsml(MHz)"] +
stem:[lambda_{a1} = 531476582.65] stem:["unitsml(fm)"]
--
...
stem:[lambda_{"croisement d/f"} = 780246291.6] stem:["unitsml(fm)"]
--
...
133 non perturbé, stem:[Delta nu_{Cs}], est égale à stem:[9192631770 " ""unitsml(Hz)"],
* la ((vitesse de la lumière dans le vide)), stem:[c], est égale à 299792458 m/s,
* la constante de Planck(((constante, de Planck))), stem:[h], est égale à stem:[6.62607015 xx 10^{-34}] stem:["unitsml(J s)"],
* la charge élémentaire, stem:[e], est égale à stem:[1.602176634 xx 10^{-19}] stem:["unitsml(C)"],
* la constante de Boltzmann, stem:[k], est égale à stem:[1.380649 xx 10^{-23}] stem:["unitsml(J//K)"],
* la constante d’Avogadro, stem:[ii(N)_"A"], est égale à stem:[6.02214076 xx 10^23^] stem:["unitsml(mol^{-1})"],
...
lm et W, sont reliées aux unités seconde, mètre, kilogramme, ampère(((ampère (A)))), kelvin, mole et candela(((candela (cd)))),
qui ont respectivement pour symbole s, m, kg, A, K, mol et cd, selon les relations, stem:["unitsml(J)" = "unitsml(kg m^2 s^{-2})"],
...
* la perméabilité magnétique du vide, stem:[mu_0], est égale à stem:[4 pi xx 10^{-7}] stem:["unitsml(H m^{-1})"] avec une incertitude-type
...
* la masse molaire du carbone 12, stem:[ii(M)(""^{12}"C")], est égale à stem:[0.012] stem:["unitsml(kg mol^{-1})"] avec une incertitude-type
...
est exprimée en stem:["unitsml(m//s)"], la seconde étant définie en fonction de stem:[Delta nu_{Cs}].
...
* L’ampère(((ampère (A)))), symbole stem:["unitsml(A)"], est l’unité de courant électrique du SI. Il est défini en prenant la valeur
numérique fixée de la charge élémentaire, stem:[e], égale à stem:[1.602176634 xx 10^{-19}] lorsqu’elle est
exprimée en stem:["unitsml(C)"], unité égale à stem:["unitsml(A s)"], la seconde étant définie en fonction de stem:[Delta nu_{Cs}].
...
rayonnement monochromatique de fréquence stem:[540 xx 10^12" ""unitsml(Hz)"], Kcd, égale à 683 lorsqu’elle est
