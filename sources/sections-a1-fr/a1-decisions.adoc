...
à la fréquence de stem:[f_{87Rb} = 6 834682610,904310] stem:["Hz"] avec une incertitude-type relative estimée
...
* la constante de Planck, stem:[h], est égale à stem:[6,626070 15 xx 10^{-34}] stem:["J s"],
