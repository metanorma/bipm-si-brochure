...
a| &#x2022; mètre | stem:[rm(m)] | ampère | stem:[rm(A)]
...
| degré Celsius | stem:["°"rm(C)] a| &#x2022; candela (bougie nouvelle) | stem:[rm(cd)]
...
| viscosité dynamique | newton-seconde par mètre carré | stem:[rm(N) cdot rm(s)//rm(m)^2] |
...
valeur stem:[3.7 xx 10^10] stem:[rm(s)^{-1}]. Le symbole de cette unité est stem:[C_i].
...
valeur de stem:[483597.9 " "rm(GHz)//rm(V)] pour la constante de Josephson, stem:[K_J], c’est-à-dire pour le quotient de
...
stem:[K_{J-90} = 483597.9] stem:[rm(GHz)//rm(V)] exactement,
...
(stem:[nu1 + nu3 + nu4 + nu5]) de ^13^C~2~H~2~, autour de stem:[1.54] stem:[mu rm(m)].
...
* les valeurs mises à jour des fréquences de la bande (stem:[nu1 + nu3]) de ^12^C~2~H~2~, autour de stem:[1.54] stem:[mu rm(m)];
...
* la constante d’Avogadro stem:[N_"A"] est égale à exactement stem:[6.02214X xx 10^23] par mole,
...
* la température thermodynamique du point triple de l’eau stem:[T_("TPW")] sera égale à stem:[273.16 " "rm(K)], avec
cependant une incertitude relative égale à celle de la valeur recommandée de k juste avant la
redéfinition, puis sa valeur sera déterminée de façon expérimentale,

* la masse molaire du carbone 12 stem:[M(""^{12}"C")] sera égale à stem:[0.012] stem:[rm(kg)" "rm(mol)^{-1}], avec cependant une
...
et de la constante d’Avogadro stem:[N_"A"], respectivement, et à modifier la façon de définir le SI, ainsi que
...
fondamentales de stem:[h], stem:[e], stem:[k], et stem:[N_"A"],
...
leurs efforts afin de déterminer expérimentalement les valeurs des constantes de stem:[h], stem:[e], stem:[k] et stem:[N_"A"]
...
à la fréquence de f199Hg = stem:[1128575290808154.8 " "rm(Hz)] avec une incertitude-type relative
...
* la constante de Planck, stem:[h], est égale à stem:[6.62607015 xx 10^{-34}] stem:[rm(J)" "rm(s)],
...
* la constante d’Avogadro, stem:[N_"A"], est égale à stem:[6.02214076 xx 10^23^] stem:[rm(mol)^{-1}],
...
* la masse molaire du carbone 12, stem:[M(""^{12}"C")], est égale à stem:[0.012] stem:[rm(kg)" "rm(mol)^{-1}] avec une incertitude-type
...
* L’ampère, symbole stem:[rm(A)], est l’unité de courant électrique du SI. Il est défini en prenant la valeur
