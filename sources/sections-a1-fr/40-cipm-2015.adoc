...
stem:[f_(40"Ca+") = 411042129776398.4 " "rm(Hz)] avec une incertitude-type relative estimée de stem:[1.2 xx 10^{-14}]{nbsp};
* la transition optique non perturbée stem:[1"S" - 2"S"] de l’atome neutre de ^1^H, à la fréquence de stem:[f_(1"H") = 1233030706593514 " "rm(Hz)] avec une incertitude-type relative estimée de stem:[9 xx 10^{-15}]{nbsp};
+
--
