...
|===
| nombre d’ondes | 1 par mètre(((mètre (m)))) | stem:["unitsml(m^{-1})"]
| entropie | joule(((joule (J)))) par kelvin(((kelvin (K)))) | stem:["unitsml(J//K)"]
| chaleur massique | joule par kilogramme kelvin(((kelvin (K)))) | stem:["unitsml(J)"//("unitsml(kg)" * "unitsml(K)")]
