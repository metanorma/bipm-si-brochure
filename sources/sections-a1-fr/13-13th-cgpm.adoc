...
[[cgpm13e1968r3]]
=== Unité SI de température thermodynamique (kelvin) (CR, 104 et _Metrologia_, 1968, 4, 43)(((kelvin (stem:["unitsml(K)"]))))
...
* les noms «&nbsp;degré Kelvin&nbsp;»(((degré kelvin))) et «&nbsp;degré&nbsp;», les symboles «&nbsp;stem:["unitsml(degK)"]&nbsp;» et «&nbsp;deg&nbsp;» et leurs règles d’emploi
...
est «&nbsp;stem:["unitsml(K)"]&nbsp;»; footnote:[Voir la Recommandation 2 (<<cipm2005r2r2,CI-2005>>) du CIPM relative à la composition
...
[[cgpm13e1698r4]]
=== Définition de l’unité SI de température thermodynamique (kelvin) (CR, 104 et _Metrologia_, 1968, 4, 43)(((kelvin (stem:["unitsml(K)"]))))
...
[[cgpm13e1968r5]]
=== Unité SI d’intensité lumineuse (candela) (CR, 104 et _Metrologia_, 1968, 4, 43-44)(((candela (stem:["unitsml(cd)"]))))
...
| chaleur massique | joule par kilogramme kelvin(((kelvin (stem:["unitsml(K)"])))) | stem:["unitsml(J)"//("unitsml(kg*K)")]
