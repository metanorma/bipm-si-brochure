...
*Unité SI de temps (seconde)* (<<CR103>> et _Metrologia_, 1968, *4*, 43) (((seconde)))
...
[.variant-title,type=quoted]
*Unité SI de température thermodynamique (kelvin)* (<<CR104>> et _Metrologia_, 1968, *4*, 43)(((kelvin (stem:["unitsml(K)"]))))
...
[.variant-title,type=quoted]
*Définition de l’unité SI de température thermodynamique (kelvin)* (<<CR104>> et _Metrologia_, 1968, *4*, 43)(((kelvin (stem:["unitsml(K)"]))))
...
[.variant-title,type=quoted]
*Unité SI d’intensité lumineuse (candela)* (<<CR104>> et _Metrologia_, 1968, *4*, 43-44)(((candela (stem:["unitsml(cd)"]))))
...
[.variant-title,type=quoted]
*Abrogation de décisions antérieures (micron et bougie nouvelle(((bougie nouvelle)))* (<<CR105>> et _Metrologia_, 1968, *4*, 44)
