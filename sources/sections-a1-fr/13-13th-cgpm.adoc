...
| chaleur massique | joule par kilogramme kelvin(((kelvin (stem:["unitsml(K)"])))) | stem:["unitsml(J)"//("unitsml(kg*K,symbol:kg cdot K)")]
| conductivité thermique | watt par mètre kelvin | stem:["unitsml(W)"//("unitsml(m*K,symbol:m cdot K)")]
