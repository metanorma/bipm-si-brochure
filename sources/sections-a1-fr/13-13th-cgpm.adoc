...
NOTE: Définition abrogée en 1979 par la 16^e^ CGPM (<<cgpm16e1979r3,Résolution 3>>).
...
symbole particulier lors de la 15^e^ CGPM en 1975 (<<cgpm15e1975r8_9,Résolution 8>>).
