...
* cette composition isotopique de l’eau est la suivante: (((mole (stem:["unitsml(mol)"]))))
+
--
[align=left]
...
Brochure sur le Système international d’unités de la manière suivante: (((mole (stem:["unitsml(mol)"]))))
+
--
