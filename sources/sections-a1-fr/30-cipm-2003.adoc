...
*Révision de la liste des radiations recommandées pour la mise en pratique de la définition du mètre* (<<PV71, page=70>> et _Metrologia_, 2004, *41*, 99-100) (((mètre (stem:["unitsml(m)"]))))
