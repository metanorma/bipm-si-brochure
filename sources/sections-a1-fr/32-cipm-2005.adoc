...
* la valeur mise à jour de la fréquence de l’étalon asservi sur l’acétylène à stem:[1.54 " "mu rm(m)];
* la valeur mise à jour de la fréquence de l’étalon asservi sur l’iode à stem:[515 " "rm(nm)];
* la fréquence de la transition de l’atome de ^87^Sr à stem:[698 " "rm(nm)];
* les fréquences des transitions de l’atome de ^87^Rb autour de stem:[760 " "rm(nm)];
* les fréquences des transitions de la bande (stem:[nu1 + nu3]) de ^12^C~2~H~2~, et des bandes (stem:[nu1 + nu3]) et
(stem:[nu1 + nu3 + nu4 + nu5]) de ^13^C~2~H~2~, autour de stem:[1.54 " "mu rm(m)].
____