...
le *_becquerel_*, symbole stem:["Bq"], égal à la seconde à la puissance moins un (Résolution 8),

*adopte* le nom spécial suivant d’unité SI pour les rayonnements ionisants:

le *_gray_*, symbole stem:["Gy"], égal au joule par kilogramme (Résolution 9).
