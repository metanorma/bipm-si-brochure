...
* Le kelvin(((kelvin (K)))), symbole stem:["unitsml(K)"], est l’unité de température thermodynamique du SI. Il est défini en
...
exprimée en stem:["unitsml(lm)"" ""unitsml(W)"^{-1}], unité égale à stem:["unitsml(cd)"" ""unitsml(sr)"" ""unitsml(W)"^{-1}], ou stem:["unitsml(cd sr kg^{-1} m^{-2} s^3)"], le ((kilogramme)), le mètre et
