...
relier les définitions du kilogramme, de l’ampère(((ampère (A)))), du kelvin et de la mole(((mole (mol)))) à des valeurs numériques
...
du kelvin(((kelvin (K)))) et de la mole(((mole (mol)))),
