...
| travail, énergie, quantité de chaleur | joule(((joule (stem:["unitsml(J)"])))) | stem:["unitsml(J)"] | stem:["unitsml(N)"*"unitsml(m)"]
| puissance | watt (((watt (stem:["unitsml(W)"])))) | stem:["unitsml(W)"] | stem:["unitsml(J/s)"]
| quantité d’électricité | coulomb(((coulomb (stem:["unitsml(C)"])))) | stem:["unitsml(C)"] | stem:["unitsml(A)"*"unitsml(s)"]
...
| flux d’induction magnétique | weber(((weber (stem:["unitsml(Wb)"])))) | stem:["unitsml(Wb)"] | stem:["unitsml(V)"*"unitsml(s)"]
...
| flux lumineux | lumen(((lumen (stem:["unitsml(lm)"])))) | stem:["unitsml(lm)"] | stem:["unitsml(cd)"*"unitsml(sr)"]
