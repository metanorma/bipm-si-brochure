...
NOTE: Définition abrogée en 1983 par la 17^e^ CGPM (<<cgpm17e1983r1,Résolution 1>>).
...
NOTE: Définition abrogée en 1967 par la 13^e^ CGPM (<<cgpm13e1968r1,Résolution 1>>).
...
| température thermodynamique footnote:[Le nom et symbole de l’unité de température thermodynamique ont été modifiés par la 13^e^ CGPM en 1967 (<<cgpm13e1968r3,Résolution 3>>).] | degré Kelvin | °K
...
. le système fondé sur les six unités de base ci-dessus est désigné sous le nom de « Système international d’unités »; footnote:[Une septième unité de base, la mole, fut adoptée par la 14^e^ CGPM en 1971 (<<cgpm14e1971r3,Résolution 3>>).]
...
|===
| Facteur par lequel l’unité est multipliée | Préfixe footnote:[D’autres préfixes furent adoptés par la 12^e^ CGPM en 1964 (<<cgpm12e1964r8,Résolution 8>>), par la 15^e^ CGPM en 1975 (<<cgpm15e1975r10,Résolution 10>>) et par la 19^e^ CGPM en 1991 (<<cgpm19e1991r4,Résolution 4>>). ] | Symbole | Facteur par lequel l’unité est multipliée | Préfixe | Symbole
...
|===
4+h| _Unités dérivées_ footnote:[La 13^e^ CGPM en 1967 (<<cgpm13e1967r6,Résolution 6>>) a ajouté d’autres unités à cette liste d’unités
