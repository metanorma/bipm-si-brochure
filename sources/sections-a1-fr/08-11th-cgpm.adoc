...
| température thermodynamique footnote:[Le nom et symbole de l’unité de température thermodynamique ont été modifiés par la 13^e^ CGPM
en 1967 (Résolution 3, _voir_ p. 58).] | degré Kelvin | °K
...
. le système fondé sur les six unités de base ci-dessus est désigné sous le nom de « Système international d’unités »; footnote:[Une septième unité de base, la mole, fut adoptée par la 14^e^ CGPM en 1971 (Résolution 3, _voir_ p. 62).]
...
|===
| Facteur par lequel l’unité est multipliée | Préfixe footnote:[D’autres préfixes furent adoptés par la 12^e^ CGPM en 1964 (Résolution 8, _voir_ p. 57), par la 15^e^ CGPM en 1975 (Résolution 10, _voir_ p. 63) et par la 19^e^ CGPM en 1991 (Résolution 4, _voir_ p. 70). ] | Symbole | Facteur par lequel l’unité est multipliée | Préfixe | Symbole
...
[cols="3",options="unnumbered"]
|===
3+h| _Unités supplémentaires_ footnote:[La 20^e^ CGPM a abrogé en 1995 la classe des unités supplémentaires dans le SI (Résolution 8, _voir_ p. 70). Ces unités sont maintenant considérées comme des unités dérivées.]
...
|===
4+h| _Unités dérivées_ footnote:[La 13^e^ CGPM en 1967 (Résolution 6, _voir_ p. 59) a ajouté d’autres unités à cette liste d’unités
