...
l’oeil par les cônes, sensibles aux luminances élevées (stem:["L" >] environ stem:[10 " "rm(cd)" "rm(m)^{-2}]), qui
...
l’oeil par les bâtonnets, sensibles aux faibles luminances (L < environ stem:[10^{-3} " "rm(cd)" "rm(m)^{-2}]), qui correspondent à la vision nocturne.] et que par conséquent elle assure une continuité
satisfaisante,
