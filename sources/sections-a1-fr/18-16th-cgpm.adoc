...
l’oeil par les bâtonnets, sensibles aux faibles luminances (ii(L) < environ stem:[10^{-3} " "rm(cd)" "rm(m)^{-2}]), qui correspondent à la vision nocturne.] et que par conséquent elle assure une continuité
satisfaisante,
