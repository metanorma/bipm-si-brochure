...
*Unité SI d’intensité lumineuse (candela)* (<<CR1979-3,page=100>> et _Metrologia_, 1980, *16*, 56)(((candela (stem:["unitsml(cd)"]))))
...
[.variant-title,type=quoted]
*Nom spécial pour l’unité SI d’équivalent de dose (sievert)* (<<CR1979-4,page=100>> et _Metrologia_, 1980, *16*, 56)(((sievert (stem:["unitsml(Sv)"]))))
