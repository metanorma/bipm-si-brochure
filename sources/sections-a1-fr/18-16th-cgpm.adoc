...
NOTE: La formulation de la définition de la candela a été modifiée par la CGPM à sa 26^e^ réunion en 2018 (<<cgpm26th2018r1r1,Résolution 1>>).
...
l’oeil par les cônes, sensibles aux luminances élevées (stem:["L" >] environ stem:[10 " cd m"^{-2}]), qui
...
l’oeil par les bâtonnets, sensibles aux faibles luminances (L < environ stem:[10^{-3} " cd m"^{-2}]), qui correspondent à la vision nocturne.] et que par conséquent elle assure une continuité
satisfaisante,
...
*adopte* le nom spécial *_sievert_*, symbole stem:["Sv"], pour l’unité SI d’équivalent de dose dans le
...
*considérant* que le symbole stem:["l"] pour l’unité litre a été adopté par le Comité international des poids
...
plusieurs pays ont adopté le symbole stem:["L"] au lieu de stem:["l"] pour l’unité litre,
...
*décide*, à titre exceptionnel, d’adopter les deux symboles stem:["l"] et stem:["L"] comme symboles utilisables
pour l’unité litre footnote:[Le Comité international a estimé encore prématuré,
