...
l’oeil par les cônes, sensibles aux luminances élevées (stem:["L" >] environ stem:[10] stem:["cd m"^{-2}]), qui
...
l’oeil par les bâtonnets, sensibles aux faibles luminances (L < environ 10^−3^ cd m^−2^), qui correspondent à la
vision nocturne.] et que par conséquent elle assure une continuité
satisfaisante,
...
*été modifiée par la CGPM* à sa 26^e^ réunion en 2018 (<<cgpm26th2018r1,Résolution 1>>).
...
Résolution d’une explication, (<<cipm1984r1,Recommandation 1>>).
