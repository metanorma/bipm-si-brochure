...
valeur de stem:[483597.9 " ""unitsml(GHz)"//"unitsml(V)"] pour la constante de Josephson(((constante, de Josephson (stem:[ii(K)_"J"," "ii(K)_"J-90"])))), stem:[ii(K)_"J"], c’est-à-dire pour le quotient de
...
et reproductible,
* qu’une étude approfondie des résultats des déterminations les plus récentes conduit à une
valeur de stem:[25812.807 " ""unitsml(Omega)"] pour la constante de von Klitzing(((constante, de von Klitzing (stem:[ii(R)_"K",ii(R)_"K-90"])))), stem:[ii(R)_K], c’est-à-dire pour le quotient de la
