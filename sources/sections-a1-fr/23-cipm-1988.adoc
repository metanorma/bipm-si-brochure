...
valeur de stem:[483597.9 " "rm(GHz)//rm(V)] pour la constante de Josephson, stem:[ii(K)_"J"], c’est-à-dire pour le quotient de
...
* que l’on adopte, par convention, pour la constante de Josephson, stem:[ii(K)_"J"], la valeur
...
* que l’on adopte par convention, pour la constante de von Klitzing, stem:[ii(R)_"K"], la valeur
