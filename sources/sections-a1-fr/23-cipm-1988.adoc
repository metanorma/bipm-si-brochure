...
valeur de stem:[483597.9 " "rm(GHz)//rm(V)] pour la constante de Josephson(((constante, de Josephson (stem:[ii(K)_"J"," "ii(K)_"J-90"])))), stem:[ii(K)_"J"], c’est-à-dire pour le quotient de
