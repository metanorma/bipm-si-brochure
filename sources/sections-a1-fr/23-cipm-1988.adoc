...
valeur de stem:[483597.9 " "rm(GHz)//rm(V)] pour la constante de Josephson, stem:[K_"J"], c’est-à-dire pour le quotient de
...
stem:[K_{"J-90"} = 483597.9 " "rm(GHz)//rm(V)] exactement,
...
NOTE: La CGPM à sa 26^e^ réunion en 2018 (<<cgpm26th2018r1r1,Résolution 1>>) a abrogé l’adoption d’une valeur conventionnelle de stem:[R_"K"].
