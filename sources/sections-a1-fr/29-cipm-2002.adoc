...
(CI-2002), figure dans les <<PV70, page=93-101>> et dans _Metrologia_, 2003, *40*, 104-115.], qui inclut{nbsp};
...
[.variant-title,type=quoted]
*Équivalent de dose* (<<PV70, page=102>>)index-range:sievert_sv-2[(((sievert (stem:["unitsml(Sv)"]))))]
