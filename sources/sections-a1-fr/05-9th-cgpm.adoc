...
*Point triple de l’eau{nbsp}; échelle thermodynamique à un seul point fixe{nbsp}; unité de quantité de chaleur (joule)* (<<CR55>> et <<CR63>>)(((joule (stem:["unitsml(J)"]))))(((kelvin (stem:["unitsml(K)"]))))index-range:point_triple[(((point triple de l’eau)))]
...
[.variant-title,type=quoted]
*Adoption de «{nbsp}degré Celsius{nbsp}» [CIPM, 1948* (<<PV21, page=88>>) *et 9^e^ CGPM, 1948* (<<CR64>>)**]** (((degré Celsius (stem:["unitsml(degC)"]))))
