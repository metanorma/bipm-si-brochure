...
[.variant-title,type=quoted]
*Nom spécial donné à l'unité SI mole par seconde, le katal, pour exprimer l'activité catalytique* (<<CR145>> et _Metrologia_, 2000, *37*, 95) index-range:katal_kat[(((katal (stem:["unitsml(kat)"]))))](((mole (stem:["unitsml(mol)"]))))
