...
[[cgpm21e1999r12]]
=== Nom spécial donné à l'unité SI mole par seconde, le katal, pour exprimer l'activité catalytique (CR, 145 et _Metrologia_, 2000, 37, 95) index-range:katal_kat[(((katal (kat))))]
