...
* la constante d’Avogadro stem:[N_"A"] est égale à exactement stem:[6.02214"X" xx 10^(23) " par mole"],
...
* la masse molaire du carbone 12 stem:[M(""^{12}"C")] sera égale à stem:[0.012 " "rm(kg)" "rm(mol)^{-1}], avec cependant une
