...
. les unités hertz, joule, coulomb(((coulomb \(C)))), lumen et watt, qui ont respectivement pour symbole stem:["unitsml(Hz)", " ""unitsml(J)", " ""unitsml(C)", " ""unitsml(lm)"], et stem:["unitsml(W)"], sont reliées aux unités seconde, mètre, kilogramme, ampère(((ampère (A)))), kelvin, mole(((mole (mol)))) et candela(((candela (cd)))),
...
stem:[1.60217"X" xx 10^(−19)] lorsqu’elle sera exprimée en stem:["unitsml(s A)"], unité du SI égale au coulomb(((coulomb \(C)))), stem:["unitsml(C)"],
...
égale au joule(((joule (J)))) par kelvin stem:["unitsml(J K^{-1})"],
...
exprimée en stem:["unitsml(s^{-1})"], unité du SI égale au hertz(((hertz (Hz)))), stem:["unitsml(Hz)"],
...
* la candela(((candela (cd)))), symbole stem:["unitsml(cd)"], est l’unité d’intensité lumineuse dans une direction donnée; son
...
lorsqu’elle est exprimée en stem:["unitsml(m^{-2} kg^{-1} s^3 cd sr)"] ou en stem:["unitsml(cd sr W^{-1})"], unité du SI égale au lumen(((lumen (lm)))) par
