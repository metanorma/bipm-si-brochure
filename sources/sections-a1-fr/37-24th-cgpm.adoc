...
* le mètre, symbole stem:[rm(m)], est l’unité de ((longueur)); son amplitude est déterminée en fixant la valeur numérique de la ((vitesse de la lumière dans le vide)) à exactement stem:[299792458] lorsqu’elle est
