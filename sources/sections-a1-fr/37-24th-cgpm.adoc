...
dans le SI des constantes de Josephson(((constante, de Josephson (stem:[rm(K)_"J"], stem:[rm(K)_"J-90"]))) et de von Klitzing(((constante, de von Klitzing (stem:[ii(R)_"K"], stem:[ii(R)_"K-90"])))), stem:[ii(K)_"J"] et stem:[ii(R)_"K"], pourraient être réduites de
...
. les unités hertz, joule, coulomb(((coulomb (C)))), lumen et watt, qui ont respectivement pour symbole stem:[rm(Hz), " "rm(J), " "rm(C), " "rm(lm)], et stem:[rm(W)], sont reliées aux unités seconde, mètre, kilogramme, ampère(((ampère (A)))), kelvin, mole et candela(((candela (cd)))),
