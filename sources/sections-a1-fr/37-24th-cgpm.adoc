...
* la vitesse de la lumière dans le vide stem:[c] est égale à exactement stem:[299792458] mètre
par seconde,
...
stem:[6.62606"X" xx 10^(−34)] lorsqu’elle sera exprimée en stem:["m"^2 " kg s"^{-1}], unité du SI égale au joule
seconde, stem:["J s"],
...
stem:[1.60217"X" xx 10^(−19)] lorsqu’elle sera exprimée en stem:["s A"], unité du SI égale au coulomb, stem:["C"],
...
exactement stem:[1.3806"X" xx 10^(−23)] lorsqu’elle sera exprimée en stem:["m"^2 " kg s"^{-2} " K"^{-1}], unité du SI
...
césium 133 au repos, à une température de stem:[0 " K"], à exactement stem:[9192631770] lorsqu’elle est
...
* la masse molaire du carbone 12 stem:[M(""^{12}"C")] sera égale à stem:[0.012 " kg mol"^{-1}], avec cependant une
