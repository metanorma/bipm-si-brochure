...
[NOTE]
====
Les définitions contenues dans cette Résolution ont été approuvées par la 9^e^ CGPM en 1948 (<<CR49>>), qui a en outre adopté le nom newton(((newton (stem:["unitsml(N)"])))) (Résolution 7) pour l’unité ((MKS)) de force.
