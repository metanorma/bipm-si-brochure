...
La définition de la candela a été modifiée par la 13^e^ CGPM en 1967 (<<cgpm13e1968r5r5,Résolution 5>>).
====
...
En 1954, la CGPM à sa 10^e^ réunion (<<cgpm10e1954r6r6,Résolution 6>>) établit un système pratique d’unités de mesure pour les relations internationales. L’ampère fut l’une des unités de base de ce système.
====
...
mètre de longueur. footnote:[NOTE: Définition de l’ampère abrogée en 2018 par la CGPM à sa 26^e^ réunion (<<cgpm26th2018r1r1,Résolution 1>>).]
