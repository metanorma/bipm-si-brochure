...
stem:[532 " "rm(nm)], à l’aide de peignes à impulsions femtosecondes{nbsp};

*propose* que la liste des fréquences étalons soit révisée pour y inclure{nbsp}:

* les valeurs mises à jour des fréquences de la bande (stem:[nu_1 + nu_3]) de ^12^C~2~H~2~, autour de stem:[1.54 " "mu rm(m)]{nbsp};

* les valeurs des fréquences de la bande (stem:[2nu_{1}]) de ^12^C~2~HD, autour de stem:[1.54 " "mu rm(m)]{nbsp};
