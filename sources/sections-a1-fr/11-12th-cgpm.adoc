...
NOTE: Le nom « becquerel » (stem:["Bq"]) a été adopté par la <<cgpm15e1975r8_9,15^e^ CGPM en 1975 (Résolution 8)>>
...
furent ajoutés par la <<cgpm15e1975r10,15^e^ CGPM en 1975 (Résolution 10)>>.