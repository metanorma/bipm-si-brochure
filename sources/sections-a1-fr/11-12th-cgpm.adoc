...
=== Curie(((curie (Ci)))) (CR, 94)

NOTE: Le nom «{nbsp}becquerel{nbsp}»(((becquerel (Bq)))) (stem:[rm(Bq)]) a été adopté par la 15^e^ CGPM en 1975 (<<cgpm15e1975r8_9r8_9,Résolution 8>>)
...
*considérant* que depuis longtemps le curie(((curie (Ci)))) est utilisé dans beaucoup de pays comme unité
...
*admet* que le curie(((curie (Ci)))) soit encore retenu comme unité en dehors du SI pour l’activité, avec la
