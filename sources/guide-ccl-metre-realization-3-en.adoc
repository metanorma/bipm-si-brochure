...
[[fig-2]]
.Si(100) stem:[2 xx 1] surface with a monoatomic step of stem:[0.13 "unitsml(nm)"]. Two unit cells indicated on the lower and one on the upper plane rotated by stem:[90 "unitsml(deg)"].
