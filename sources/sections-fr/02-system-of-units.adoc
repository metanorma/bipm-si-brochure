...
valeur numérique fixée de la constante de Planck, stem:[h], égale à stem:[6,626070 15 xx 10^{−34}]
...
[stem%unnumbered]
++++
1 " kg" = ( h / {6,626 07015 xx 10^{-34}}) " m"^{-2} "s"
++++
...
[stem%unnumbered]
++++
1 " kg" = (299792458)^2 / {6,62607015 xx 10^{-34}} {h Delta nu_{"Cs"}} / c^2 ~~ 1,4755214 xx 10^40 {h Delta nu_{"Cs"}} / c^2
++++
...
stem:[1//(1,602176 634 xx 10^{-19})] charges élémentaires par seconde.
