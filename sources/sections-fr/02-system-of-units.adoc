...
les valeurs de stem:[epsilon_0], stem:[ii(Z)_0], et stem:[ii(Y)_0] doivent désormais
...
stem:[ii(Z)_0// mu_0 = c] restent exacts. Au moment de l’adoption de l’actuelle définition de l’ampère,
...
est exprimée en fonction des constantes stem:[ii(K)_{"cd"}], stem:[h] et stem:[Delta nu_{"Cs"}]:
