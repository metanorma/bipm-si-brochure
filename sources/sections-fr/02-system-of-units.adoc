...
la constante de Boltzmann relie l’entropie, stem:[S], au nombre stem:[ii Omega] d’états quantiques accessibles,
...
[stem%unnumbered]
++++
ii(M)("X") = A_"r" ("X") [ii(M)(""^{12}"C")//12] = A_"r" ("X") ii(M)_{rm(u)}
++++
...
égale à stem:[M](^12^C)/12, et stem:[m_{rm(u)}] est la
