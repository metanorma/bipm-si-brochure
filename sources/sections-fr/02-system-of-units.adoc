...
(((hertz (Hz))))(((joule (J))))(((kelvin (K))))(((lumen (lm))))(((mètre (m))))(((mole (mol))))
...
[[dim_des_grandeurs]]
==== Dimension des grandeurs(((grandeurs,de base)))
...
formés à l’aide de préfixes SI(((préfixes SI))).
...
[[table-6]]
.Exemples d’unités dérivées cohérentes du SI dont le nom et le symbole comprennent des unités dérivées cohérentes du SI ayant un nom spécial et un symbole particulier (((grandeurs,dérivées)))(((joule (J))))
[cols="4",options="header"]
|===
...
la seconde moins un, et les unités SI «&nbsp;gray&nbsp;» et «&nbsp;sievert&nbsp;» plutôt que le joule(((joule (J)))) par
