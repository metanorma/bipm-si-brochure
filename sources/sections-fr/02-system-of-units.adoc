...
* *la fréquence de la transition hyperfine de l’état fondamental de l’atome de césium 133 non perturbé, stem:[Delta ii(nu)_{"Cs"}], est égale à stem:[9192631770 " "rm(Hz)],*
...
* *la constante d’Avogadro, stem:[ii(N)_"A"], est égale à stem:[6.02214076 xx 10^23 " "rm(mol)^{-1}],*
...
| constante d’Avogadro | stem:[ii(N)_"A"] | stem:[6.02214076 xx 10^{23}] | stem:[rm(mol)^{-1}]
...
la constante de Boltzmann relie l’entropie, stem:[ii(S)], au nombre stem:[ii Omega] d’états quantiques accessibles,
...
La constante d’Avogadro, stem:[ii(N)_"A"], est une constante de proportionnalité entre la grandeur
...
| courant électrique | stem:[ii(I), i] | ampère | stem:[rm(A)]
| température thermodynamique | stem:[ii(T)] | kelvin | stem:[rm(K)]
| quantité de matière | stem:[n] | mole | stem:[rm(mol)]
| intensité lumineuse | stem:[ii(I)_"v"] | candela | stem:[rm(cd)]
...
cette relation, l’ampère est exprimé en fonction des constantes stem:[e] et stem:[Delta ii(nu)_{"Cs"}]:
...
traversés par du courant, fixait la valeur de la perméabilité magnétique du vide stem:[ii(mu)_0] (également
...
La nouvelle définition de l’ampère fixe la valeur numérique de stem:[e] et non plus celle de stem:[ii(mu)_0].
...
stem:[ii(Z)_0// ii(mu)_0 = c] restent exacts. Au moment de l’adoption de l’actuelle définition de l’ampère,
...
monochromatique de fréquence stem:[ii(nu) = 540 xx 10^(12) " "rm(Hz)]. En inversant cette relation, la candela
