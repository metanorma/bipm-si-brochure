...
(((hertz (Hz))))(((joule (J))))(((kelvin (K))))(((lumen (lm))))(((mètre (m))))(((mole (mol))))(((seconde)))
...
==== Unités de base (((symboles,des grandeurs))) (((symboles,unités))) (((symboles,unités (obligatoires))))
...
Le kelvin(((kelvin (K)))) et le degré Celsius sont aussi les unités de l’Échelle internationale de température
...
La définition du stéradian(((stéradian (sr)))) est donnée au bas du <<table-4>>. [[monochromatique]]
...
[[dim_des_grandeurs]]
==== Dimension des grandeurs (((grandeurs,de base))) (((symboles,des grandeurs)))
...
| fréquence | hertz(((hertz (Hz)))) footnote:[Le hertz ne doit être utilisé que pour les phénomènes périodiques et le becquerel(((becquerel (Bq)))) que pour les
...
[[table-6]]
.Exemples d’unités dérivées cohérentes du SI dont le nom et le symbole comprennent des unités dérivées cohérentes du SI ayant un nom spécial et un symbole particulier (((grandeurs,dérivées)))(((joule (J)))) index-range:radian_rad-1[(((radian (rad))))]
[cols="4",options="header"]
|===
...
utilisée pour exprimer des différences de température. [[radian_rad-1]] [[symboles_derivees]]
...
[[cls-236]]
==== Les unités SI dans le cadre de la théorie de la relativité générale(((relativité générale)))
