...
| température Celsius | degré Celsius(((degré Celsius (°C)))) footnote:[Le degré Celsius(((degré Celsius (°C)))) est utilisé pour exprimer des températures Celsius. La valeur numérique d’une
