...
grandeur «{nbsp}masse{nbsp}» mais stem:[phi = 30 "unitsml(deg)" 22 "unitsml(prime)" 8 "unitsml(dprime)"]
...
stem:[22 "unitsml(deg)" 12 "unitsml(prime)"], sauf dans les domaines tels que la navigation, la cartographie, l’astronomie et la
