...
d’abord proposés par la CGPM à sa 9^e^ réunion (<<CR1948-7,1948, Résolution 7>>). Ils furent ensuite
...
Le symbole du litre(((litre (stem:["unitsml(L)"] ou stem:["unitsml(l)"])))) constitue une exception à cette règle. La CGPM à sa 16^e^ réunion
(<<CR1979-6,1979, Résolution 6>>) a approuvé l’utilisation de la lettre L en majuscule ou l en minuscule comme
...
Conformément à la décision de la CGPM à sa 9^e^ réunion (<<CR1948-7,1948, Résolution 7>>) et à sa
22^e^ réunion (<<CR2003-10,2003, Résolution 10>>), les nombres comportant un grand nombre de chiffres
...
[NOTE]
====
Lorsque le SI a été adopté par la <<CGPM_MET_11>>, la classe des
...
le SI (Résolution 8 adoptée par la <<CR1995-8,CGPM à
