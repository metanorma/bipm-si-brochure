...
[[scls541]]
==== Valeur et valeur numérique d’une grandeur; utilisation du calcul formel index-range:calcul_formel[(((calcul formel)))]
...
Cette règle signifie que le symbole stem:["unitsml(°C)"] pour le degré Celsius(((degré Celsius (°C)))) est précédé d’une espace pour
exprimer la valeur de la température Celsius, stem:[t].

[NOTE]
====
stem:[t = 30.2 " ""unitsml(°C)"] +
mais pas stem:[t = 30.2 " ""unitsml(°C)"] +
ni stem:[t = 30.2 " ""unitsml(°C)"]
====
...
de stem:[m_"n"], dans le cas présent : stem:[u(m_"n") = 0.000000021 xx 10^{-27} " " "unitsml(kg)"]. Si une incertitude élargie
...
préfixes du SI, si cela est préférable (stem:[mu "unitsml(m//m)"], stem:["unitsml(nmol//mol)"]). Cela n’est pas possible avec les
