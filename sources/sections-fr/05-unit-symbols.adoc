...
[NOTE]
====
Par exemple, la différence de potentiel électrique maximale s’exprime sous la forme: stem:[U_{"max"} = 1000 " " V] mais pas stem:[U = 1000 " " V_{"max"}]. La fraction massique du cuivre de l’échantillon de silicium s’exprime sous la forme stem:[w("Cu") = 1.3 xx 10^{-6}] mais pas stem:[1.3 xx 10^{-6}] stem:[rm(w)//rm(w)].
====
...
NOTE: stem:[ l = 10.234 " "rm(m)] mais pas stem:[l = 10 " "rm(m)" " 23.4 " "rm(cm)]
...
longueur stem:[r] depuis le point commun, divisée par la longueur du vecteur rayon, stem:[theta = s//r] stem:[rm(rad)].
...
d’une sphère de rayon stem:[r] et le rayon au carré, stem:[Omega = A//r^2] stem:[rm(sr)]. Un stéradian correspond à l’angle
solide pour lequel stem:[A = r^2], ainsi stem:[1 " "rm(sr) = 1].
