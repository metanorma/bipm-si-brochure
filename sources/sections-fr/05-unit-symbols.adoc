...
=== Règles et conventions stylistiques servant à exprimer les valeurs des grandeurs index-range:symboles_recommandes[(((grandeurs,symboles (recommandés))))]
index-range:valeur_numerique[(((grandeurs,valeur numérique)))]
...
d’unité pour le degré, la minute et la seconde d’angle(((angle))) plan (respectivement °, ′ e t ″)
...
et celle de l’angle(((angle))) solide est le stéradian, symbole stem:[rm(sr)].
...
L’angle(((angle))) solide, exprimé en stéradian, correspond au rapport entre l’aire stem:[ii(A)] de la surface
...
au carré en général. [[regles_ecriture]] [[symboles_recommandes]]
