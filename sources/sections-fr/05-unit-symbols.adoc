...
grammaticales ordinaires (voir un exemple en anglais page <<english-doc,english_example>>).
...
d’une sphère de rayon stem:[r] et le rayon au carré, stem:[ii Omega = A//r^2] stem:[rm(sr)]. Un stéradian correspond à l’angle
