...
mas, stem:[mu " ""unitsml(as)"] et pas, l’arcseconde étant un autre nom pour la seconde d’angle(((angle))) plan.] | stem:["&#x2033;"] | stem:[1&#x2033; = (1//60)&#x2032; = (pi //648000) " ""unitsml(rad)"]
...
potentiel de 1 V dans le vide. L’électronvolt est souvent combiné aux préfixes du SI.] | stem:["unitsml(eV)"] | stem:[1] stem:["unitsml(eV)"] stem:[= 1.602176634 xx 10^{-19}] stem:["unitsml(J)"]
