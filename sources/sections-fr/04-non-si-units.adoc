...
mas, stem:[mu " "rm(as)] et pas, l’arcseconde étant un autre nom pour la seconde d’angle plan.] | stem:["&#x2033;"] | stem:[1&#x2033; = (1//60)&#x2032; = (pi //648000) " "rm(rad)]
...
comme signifiant que stem:[m = 10 "lg"(ii(X)//ii(X)_0)]. L’usage des unités néper, bel et décibel avec le SI a
