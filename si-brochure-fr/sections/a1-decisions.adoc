...
* la constante magnétique (la perméabilité du vide) μ~0~ sera égale à stem:[4 pi xx 10^{-7}] stem:["H m"^{-1}], avec
...
* la constante de Planck, stem:[h], est égale à 6,626 070 stem:[15 xx 10^{-34}] stem:["J s"],
* la charge élémentaire, stem:[e], est égale à 1,602 176 stem:[634 xx 10^{-19}] stem:["C"],
* la constante de Boltzmann, stem:[k], est égale à 1,380 stem:[649 xx 10^{-23}] stem:["J/K"],
...
stem:[540 xx 10^12] Hz, K~cd~, est égale à 683 lm/W,
...
* la perméabilité magnétique du vide, μ^0^, est égale à stem:[4 pi xx 10^{-7}] stem:["H m"^{-1}] avec une incertitude-type
