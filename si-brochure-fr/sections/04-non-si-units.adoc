...
du dalton est la valeur recommandée dans l’ajustement de 2018 de CODATA.] | Da | 1 Da = 1,660 539 066 60(50) × 10^−27^ kg
...
potentiel de 1 V dans le vide. L’électronvolt est souvent combiné aux préfixes du SI.] | eV | 1 eV = 1,602 176 634 × 10^−19^ J
...
stem:[ln = log_e]. Le bel et le décibel, B et dB, stem:[1 " dB" = (1//10) " B"],
sont utilisés pour exprimer la valeur
de grandeurs dont la valeur numérique est un logarithme de base 10 d’un rapport de
grandeurs, stem:["lg" = log_10]. L’égalité stem:[L_X = m " dB" = (m//10) " B"] (où m est un nombre) est comprise
